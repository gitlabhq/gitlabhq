  ...
  module Cop
    module Migration
      class WithLockRetriesDisallowedMethod < RuboCop::Cop::Base
        ...
        MSG_ONLY_ONE_FK_ALLOWED = "Avoid adding more than one foreign key within the `with_lock_retries`. See https://docs.gitlab.com/development/migration_style_guide/#examples"
