  ...
  module Cop
    module Gitlab
      class FeatureFlagWithoutActor < RuboCop::Cop::Base
        MSG = 'Do not use feature flags without an explicit actor. See https://docs.gitlab.com/development/feature_flags/#feature-actors'

        # @!method using_feature_flag_without_actor?(node)
