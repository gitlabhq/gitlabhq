  ...
  module Cop
    module Gitlab
      ...
      class BulkInsert < RuboCop::Cop::Base
        MSG = 'Use the `BulkInsertSafe` concern, instead of using `LegacyBulkInsert.bulk_insert`. See https://docs.gitlab.com/development/database/insert_into_tables_in_batches/'
