...
gem 'gitlab-grape-openapi', '~> 0.4.0', feature_category: :api
...
gem 'gitlab-labkit', '~> 4.6.0', feature_category: :error_budgets
...
group :test do
  ...
  gem 'gitlab_quality-test_tooling', '~> 3.21.1', require: false, feature_category: :tooling
