...
* Add `collation: utf8_general_ci` to config/database.yml as seen in [config/database.yml.mysql](https://github.com/gitlabhq/gitlabhq/blob/7-4-stable/config/database.yml.mysql)
