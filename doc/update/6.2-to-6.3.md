...
```
git diff 6-2-stable-ee:config/gitlab.yml.example 6-3-stable-ee:config/gitlab.yml.example
git diff 6-1-stable-ee:config/gitlab.yml.example 6-3-stable-ee:config/gitlab.yml.example # if you upgrading from 6-1
```
