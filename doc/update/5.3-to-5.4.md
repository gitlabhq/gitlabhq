...
```bash
sudo cd /home/git/gitlab/config
sudo -u git cp gitlab.yml gitlab.yml.old
sudo -u git curl --output gitlab.yml https://raw.github.com/gitlabhq/gitlabhq/5-4-stable/config/gitlab.yml.example
sudo -u git vim gitlab.yml
```

```bash
sudo cd /home/git/gitlab/config
sudo -u git cp puma.rb puma.rb.old
sudo -u git curl --output puma.rb https://raw.github.com/gitlabhq/gitlabhq/5-4-stable/config/puma.rb.example
sudo -u git vim puma.rb
```
