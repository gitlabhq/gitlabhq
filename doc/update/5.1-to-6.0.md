...
- Make `/home/git/gitlab/config/gitlab.yml` the same as [`lib/support/nginx/gitlab`](/lib/support/nginx/gitlab) but with your settings.
- Make `/home/git/gitlab/config/unicorn.rb` the same as [`config/unicorn.rb.example`](/config/unicorn.rb.example) but with your settings.
