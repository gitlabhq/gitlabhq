...
If you are running **CentOS** or **Red Hat Enterprise Linux** and are upgrading to 7.4.x from 7.2.x or lower, you need to update
to 7.3.2 _first_ by following the steps below in order to avoid migration issues.

Once you have updated the codebase and applied all the migrations, you can _then_ upgrade to 7.4.3.

We are working on a patch to fix this migration issues.
