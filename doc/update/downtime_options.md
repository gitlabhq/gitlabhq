...
To perform a zero downtime upgrade, see the documentation for your installation method: [Helm charts](https://docs.gitlab.com/charts/installation/upgrade/), [GitLab Operator](https://docs.gitlab.com/operator/gitlab_upgrades/), or [multi-node instances](zero_downtime.md).
