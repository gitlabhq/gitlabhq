...
1. On the left sidebar, select **Search or go to** and find the project you want to clone. If you've [turned on the new navigation](../../user/interface_redesign.md), this field is on the top bar.
