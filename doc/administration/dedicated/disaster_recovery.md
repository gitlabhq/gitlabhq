...
- Make sure both regions are [supported by GitLab Dedicated](create_instance/data_residency_high_availability.md#primary-regions).
  If you select a secondary region with [limited support](create_instance/data_residency_high_availability.md#aws-ses), the recovery time and point objectives do not apply.
...
- Some secondary regions have limited support and are not covered by the RPO and RTO targets.
  ...
  For more information, see secondary regions with [limited support](create_instance/data_residency_high_availability.md#aws-ses).
