...
| [Custom certificates](configure_instance/network_security.md#custom-certificate-authorities) | You import your SSL certificates. GitLab maintains secure connections to your private services. | Switchboard |
...
| Feature | Description | Set up with |
|------------|-------------|-----------------|
| [Application logs](monitor.md) | Manage access to application logs stored in S3 bucket for monitoring and troubleshooting. | Switchboard |
