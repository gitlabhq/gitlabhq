...
| Limitations when running in Kubernetes, Amazon ECS, or similar                                        | On Kubernetes, Gitaly Cluster (Praefect) is in beta and not generally available, and Gitaly has known limitations. For more information, see [Gitaly Cluster on Kubernetes](#gitaly-cluster-on-kubernetes) and [epic 6127](https://gitlab.com/groups/gitlab-org/-/epics/6127). On Amazon ECS or similar, Gitaly Cluster (Praefect) is not supported.                                                                     | For production deployments, use our [reference architectures](../../reference_architectures/_index.md).                                                                                                                                                                                                                                                                                                                                                |
