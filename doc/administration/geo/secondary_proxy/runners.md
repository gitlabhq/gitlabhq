...
- [Introduced](https://gitlab.com/groups/gitlab-org/-/work_items/9779) in GitLab 16.8 [with a feature flag](../../feature_flags/_index.md) named `geo_proxy_check_pipeline_refs`. Disabled by default.
