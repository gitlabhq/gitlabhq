...
| `EXTERNAL_URL`                               | string  | Specify the external URL at the [time of installation](https://docs.gitlab.com/omnibus/settings/configuration/#specifying-the-external-url-at-the-time-of-installation).                                                                                                                                                     |
