...
| `gitlab_openbao_request_duration_seconds`                                      | Histogram |  19.4 | `operation`                                                             | Duration in seconds of each HTTP call from Rails to OpenBao. Premium and Ultimate only. |
