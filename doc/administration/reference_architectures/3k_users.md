...
| PostgreSQL[^cluster-topology-external-database]                    | 3     | 2 vCPU, 7.5 GB memory | `n1-standard-2` | `m5.large`  |
...
| Gitaly[^cluster-topology-storage-cluster], [^cluster-topology-storage-specs]            | 3     | 4 vCPU, 15 GB memory  | `n1-standard-4` | `m5.xlarge` |
