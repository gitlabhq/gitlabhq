...
| PostgreSQL[^external-database]                  | 3     | 8 vCPU, 30 GB memory    | `n1-standard-8`             | `m5.2xlarge`                | `D8s v3`                      |
...
| Gitaly[^storage-cluster], [^storage-specs]      | 3     | 16 vCPU, 60 GB memory   | `n1-standard-16`            | `m5.4xlarge`                | `D16s v3`                     |
...
| GitLab Rails[^auto-scaling-groups]              | 3     | 32 vCPU, 28.8 GB memory | `n1-highcpu-32`             | `c5.9xlarge`                | `F32s v2`                     |
...
PostgreSQL, with Patroni managing its failover, will default to using `pg_rewind` to handle conflicts.
...
| PostgreSQL[^cluster-topology-external-database]                   | 3     | 8 vCPU, 30 GB memory  | `n1-standard-8`  | `m5.2xlarge` |
...
| Gitaly[^cluster-topology-storage-cluster], [^cluster-topology-storage-specs]           | 3     | 16 vCPU, 60 GB memory | `n1-standard-16` | `m5.4xlarge` |
