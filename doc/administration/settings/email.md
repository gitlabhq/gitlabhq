...
- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/355964) in GitLab 15.9 [with a feature flag](../feature_flags/_index.md) named `deactivation_email_additional_text`. Disabled by default.
...
- Notifications to inherited group members [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/463016) in GitLab 17.7 [with a feature flag](../feature_flags/_index.md) named `pat_expiry_inherited_members_notification`. Disabled by default.
