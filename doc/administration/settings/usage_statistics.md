...
GitLab Enterprise Edition can receive paid features by [enabling registration features](../../administration/settings/usage_statistics.md#enable-registration-features) and sending us
