...
- The hardware needed for the models, see the [Supported models and Hardware requirements documentation](../self_hosted_models/supported_llm_serving_platforms.md).
