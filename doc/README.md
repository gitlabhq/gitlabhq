...
- **(EES/EEP)** [Elasticsearch](integration/elasticsearch.md): Enable Elasticsearch,
  a flexible, scalable and powerful search service to keep GitLab's search fast when dealing with huge amount of data.
