...
- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/371332) in GitLab 15.4 [with a feature flag](../administration/feature_flags/_index.md) named `google_cloud`. Disabled by default.
