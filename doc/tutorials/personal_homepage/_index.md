...
- On the left sidebar, select **Search or go to**, select **Your work**, then select **Home**. If you've [turned on the new navigation](../../user/interface_redesign.md), this field is on the top bar.
