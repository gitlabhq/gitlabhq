...
1. On the left sidebar, at the top, select **Create new** ({{< icon name="plus" >}}) and select **New group**. If you've [turned on the new navigation](../../user/interface_redesign.md), this button is in the upper-right corner.
...
1. Decide on the scope of the board.
   ...
   severity to issues.
1. On the left sidebar, select **Search or go to** and find your **triage-tutorial** group. If you've [turned on the new navigation](../../user/interface_redesign.md), this field is on the top bar.
