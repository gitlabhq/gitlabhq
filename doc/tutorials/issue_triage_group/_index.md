...
description: Set up scoped labels and a shared group issue board across multiple projects to triage issues by type, severity, and priority.
...
A [group](../../user/group/_index.md) is, in essence, a container for multiple projects. With a group, you can manage multiple projects and communicate with group members all at once.
...
1. Go to the **Open** list.
   ...
   For now, proceed with the **Open** list.
1. On the **Open** list, select the **Create new issue** icon ({{< icon name="plus" >}}).
1. Complete the fields:
   - Under **Title**, enter `User registration`.
   - Select the project to which this issue applies. This example uses `test-project-1`.
