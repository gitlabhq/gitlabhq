...
1. On the left sidebar, select **Search or go to** and find your **Web App Dev** group. If you've [turned on the new navigation](../../user/interface_redesign.md), this field is on the top bar.
1. Select **Create new** ({{< icon name="plus" >}}) and **New subgroup**. If you've [turned on the new navigation](../../user/interface_redesign.md), this button is in the upper-right corner.
...
1. On the left sidebar, select **Search or go to** and find your `Frontend` subgroup. If you've [turned on the new navigation](../../user/interface_redesign.md), this field is on the top bar.
1. On the left sidebar, at the top, select **Create new** ({{< icon name="plus" >}}) and select **New project/repository**. If you've [turned on the new navigation](../../user/interface_redesign.md), this button is in the upper-right corner.
