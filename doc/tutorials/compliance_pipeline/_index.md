...
1. On the left sidebar, select **Search or go to** and find the `Tutorial group` group. If you've [turned on the new navigation](../../user/interface_redesign.md), this field is on the top bar.
...
1. On the left sidebar, select **Search or go to** and find the `Tutorial compliance project` project. If you've [turned on the new navigation](../../user/interface_redesign.md), this field is on the top bar.
...
1. On the left sidebar, select **Search or go to** and find the `Tutorial project` project. If you've [turned on the new navigation](../../user/interface_redesign.md), this field is on the top bar.
