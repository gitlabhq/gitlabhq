...
1. On the left sidebar, select **Search or go to** and find the `my-pipeline-execution-policy` project. If you've [turned on the new navigation](../../user/interface_redesign.md), this field is on the top bar.
