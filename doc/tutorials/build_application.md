...
| [Set up CI/CD functions](set_up_cicd_functions/_index.md) | Learn how to set up the steps component and configure a CI/CD pipeline to use the step in a job. | |
