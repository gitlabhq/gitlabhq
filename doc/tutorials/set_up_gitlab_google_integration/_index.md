...
1. On the left sidebar, select **Search or go to** and find your group or project. If you've [turned on the new navigation](../../user/interface_redesign.md), this field is on the top bar. If you configure this on a group, settings apply to all projects within by default.
