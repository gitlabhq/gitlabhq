...
description: Browse a project's open issues to check for duplicates, then create a new issue with an assignee, labels, and a milestone.
...
![A list of issues sorted by Created date. A vertical ellipsis control and a "New items" button are in the upper-right corner.](img/issue_list_v18_10.png)
...
1. If you know who in the project should be assigned this task, select an **Assignee**. Select **assign yourself** if you intend to work on this issue.
