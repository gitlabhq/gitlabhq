...
![Sidebar showing menu items under the project header, such as "Manage" and "Plan." Under the plan header is the "Issues" link.](img/sidebar_v18_9.png)

A list of all open issues appears:

![A listing of issues, each one with its own title. There is, additionally, two buttons in the upper-right, "Bulk edit" and "New item"](img/issue_list_v18_9.png)
...
![The New Issue dialog has the fields "Type", "Title", and "Description", as well as several additional fields in a sidebar, "Assignee", "Labels", "Milestone", "Dates", and "Contacts."](img/new_issue_v18_9.png)
...
![The listing of issues now contains the previously created issue in the previous example image, which was titled "My New Issue."](img/revised_issue_list_v18_9.png)
