...
# Make sure Git is version 2.24.2 or higher (minimal supported version is 2.22.0)
git --version
```
...
cd /tmp
curl --remote-name --location --progress https://www.kernel.org/pub/software/scm/git/git-2.24.2.tar.gz
echo 'ad5334956301c86841eb1e5b1bb20884a6bad89a10a6762c958220c7cf64da02  git-2.24.2.tar.gz' | shasum -a256 -c - && tar -xzf git-2.24.2.tar.gz
cd git-2.24.2/
