...
Install the required packages (needed to compile Ruby and native extensions to Ruby gems):
    ...
    sudo apt-get install -y build-essential zlib1g-dev libyaml-dev libssl-dev libgdbm-dev libreadline-dev libncurses5-dev libffi-dev curl openssh-server redis-server checkinstall libxml2-dev libxslt-dev libcurl4-openssl-dev libicu-dev logrotate libmysql-ruby libmysqlclient-dev
