...
### Clone the Source
    ...
    sudo -u git -H git clone https://gitlab.com/gitlab-org/gitlab-ce.git -b 7-13-stable-ee gitlab

**Note:** You can change `7-13-stable-ee` to `master` if you want the *bleeding edge* version, but never install master on a production server!
