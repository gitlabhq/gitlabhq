...
Ensure that the version of redis-server installed is greater than 2.0.0 or there will be problems with Sidekiq.
If you installed an older version of redis-server, remove it:

    sudo apt-get remove redis-server
    
Install the latest version of redis-server by following the instructions at http://redis.io/topics/quickstart.
