...
destruction time. See
[Adapters and runtime](rapid_diffs_guidelines.md#adapters-and-runtime) for
cleanup rules.
...
For the rules that every Rapid Diffs change must follow, see
[Rapid Diffs guidelines](rapid_diffs_guidelines.md).
