...
While it might be tempting to store serialized data in the database, there are many
...
this might not be a problem, but when storing millions of rows, such a migration
