...
**Important**: Starting with GitLab 18.0, event data is collected from GitLab Self-Managed instances, providing more detailed insights than the aggregated metrics collected in previous versions.
