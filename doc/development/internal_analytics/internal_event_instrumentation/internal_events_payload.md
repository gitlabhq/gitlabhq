...
Starting with GitLab 18.0, GitLab Self-Managed and Dedicated instances collect and send structured events, self-describing events, page views, and page pings. This represents a significant change from previous versions where only aggregated metrics were collected from GitLab Self-Managed instances.
