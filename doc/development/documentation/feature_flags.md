...
> - [Generally available](issue-link) in GitLab X.Y. [Feature flag <flag name> removed](issue-link) removed.
```
...
> - [Generally available](issue-link) in GitLab 14.0. [Feature flag <flag name> removed](issue-link) removed.
```
