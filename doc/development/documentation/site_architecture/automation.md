...
| [REST API OpenAPI V3 documentation](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/openapi/openapi_v3.yaml) | [Documenting REST API resources](../restful_api_styleguide.md) | [API Platform](https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/api/) |
