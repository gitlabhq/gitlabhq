...
| **Group Access Token** | Manual/API | Group + subgroups/projects (**HIGH RISK**) | Email notifications | **Rarely recommended** - use Service Account instead | Free+ (GitLab Self-Managed) |
