...
1. Access to AI features depends on several factors, such as: their maturity, if they are enabled on GitLab Self-Managed, if they are bundled within an add-on etc.
