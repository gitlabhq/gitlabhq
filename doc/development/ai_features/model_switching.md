...
This feature is available for GitLab.com and GitLab Self-Managed instances using the cloud-connected AI Gateway.
...
- On GitLab Self-Managed instances using the cloud-connected AI Gateway, this feature is available at the instance level.

This guide explains how to add new models to make them selectable by users on both SaaS and GitLab Self-Managed instances.
...
- Please note that adding a new model will automatically make it available for the feature, not just for GitLab.com, but also for GitLab Self-Managed instances using the cloud-connected AI Gateway.
