...
For more information on authentication request limits, see [Git and container registry failed authentication ban](../../user/gitlab_com/rate_limits.md#git-and-container-registry-failed-authentication-ban).
