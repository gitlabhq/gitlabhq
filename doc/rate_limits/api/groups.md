...
- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/152733) rate limit for groups and projects API in GitLab 17.1 with a [flag](../../administration/feature_flags/_index.md) named `rate_limit_groups_and_projects_api`. Disabled by default.
...
- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/245318) a rate limit on creating groups in GitLab 19.3 with a [flag](../../administration/feature_flags/_index.md) named `namespace_create_rate_limit`. Disabled by default.
...
- Is configured through the Projects API rate limits settings. For more information, see [Configure rate limits on listing project members](projects.md#configure-rate-limits-on-listing-project-members).
