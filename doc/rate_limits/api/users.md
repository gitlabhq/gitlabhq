...
- Rate limits for Users API [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/452349) in GitLab 17.1 with a [flag](../../administration/feature_flags/_index.md) named `rate_limiting_user_endpoints`. Disabled by default.
