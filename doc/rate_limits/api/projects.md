...
title: Projects API rate limits
...
- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/421909) rate limit for the group and projects API in GitLab 17.1 with a [flag](../../administration/feature_flags/_index.md) named `rate_limit_groups_and_projects_api`. Disabled by default.
...
- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/245318) a rate limit on creating projects in GitLab 19.3 with a [flag](../../administration/feature_flags/_index.md) named `namespace_create_rate_limit`. Disabled by default.
