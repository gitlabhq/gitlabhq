...
- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/344856) in GitLab 15.7 [with a feature flag](../../administration/feature_flags/_index.md) named `incident_declare_slash_command`. Disabled by default.
