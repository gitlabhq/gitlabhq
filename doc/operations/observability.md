...
1. On the left sidebar, select **Search or go to** and find your group where the feature flag is enabled. If you've [turned on the new navigation](../user/interface_redesign.md), this field is on the top bar.
1. On the left sidebar, select **Observability**.
