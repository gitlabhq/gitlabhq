...
1. On the left sidebar, select **Search or go to** and find your private or internal project. If you've [turned on the new navigation](../../interface_redesign.md), this field is on the top bar.
