...
| Maximum job retry rate per job (for a given user)                                | `3` each minute                                                                                            | See [Job retry and manual job run rate limits](../../administration/cicd/limits.md#job-retry-and-manual-job-run-rate-limits). |
| Maximum job retry rate per project (for a given user)                            | `1250` each minute                                                                                         | See [Job retry and manual job run rate limits](../../administration/cicd/limits.md#job-retry-and-manual-job-run-rate-limits). |
| Maximum manual job run rate per job (for a given user)                           | `3` each minute                                                                                            | See [Job retry and manual job run rate limits](../../administration/cicd/limits.md#job-retry-and-manual-job-run-rate-limits). |
| Maximum manual job run rate per project (for a given user)                       | `750` each minute                                                                                          | See [Job retry and manual job run rate limits](../../administration/cicd/limits.md#job-retry-and-manual-job-run-rate-limits). |
