...
1. On the left sidebar, select **Search or go to** and find the project you want to be a member of. If you've [turned on the new navigation](../../interface_redesign.md), this field is on the top bar.
...
1. On the left sidebar, select **Search or go to** and find the project you requested access to. If you've [turned on the new navigation](../../interface_redesign.md), this field is on the top bar.
