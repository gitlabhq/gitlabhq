...
- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/129534) in GitLab 16.7 as an [experiment](../../../policy/development_stages_support.md) [with a feature flag](../../../administration/feature_flags/list.md) named `pages_multiple_versions_setting`. Disabled by default.
