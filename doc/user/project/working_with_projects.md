...
1. On the left sidebar, select your avatar and then your username. If you've [turned on the new navigation](../interface_redesign.md), this button is in the upper-right corner.
...
1. On the left sidebar, select **Search or go to** > **View all my projects**. If you've [turned on the new navigation](../interface_redesign.md), this field is on the top bar.
