...
- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/550262) in GitLab 18.5 [with a flag](../../../administration/feature_flags/_index.md) named `work_item_status_mvc2`. Disabled by default.
