...
- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/111621) in GitLab 15.10 [with a feature flag](../../../administration/feature_flags/_index.md) named `google_play_integration`. Disabled by default.
