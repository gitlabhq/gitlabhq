...
GitLab Issues are powerful tool for discussing ideas and planning and tracking work.
However, many organizations have been using Jira for these purposes
and have existing data and business processes built into it.

While you can always migrate content from Jira to GitLab Issues, you can also
opt to continue using Jira, using it together with GitLab through our integration.
...
in Jira. You will be able to take the following actions in GitLab.
...
You can also use [Jira's Smart Commits](https://confluence.atlassian.com/fisheye/using-smart-commits-298976812.html) directly from GitLab, as covered in the article [How and why to integrate GitLab with
