...
- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/454372) in GitLab 17.0 [with a feature flag](../../../administration/feature_flags/_index.md) named `beyond_identity_exclusions`. Enabled by default.
