...
- The primary author, which is the `@duo-developer` [service account](../profile/service_accounts.md).
  ...
  on the project where the GitLab Duo Agent Platform was used. The service account is the owner of the token.
...
correctly attributed to the GitLab Duo Agent Platform service account.
