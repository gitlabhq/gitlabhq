...
- [Introduced](https://gitlab.com/groups/gitlab-org/-/epics/14153) as a private beta in GitLab 17.4 [with a feature flag](../../../../administration/feature_flags/_index.md) named `duo_workflow`. Enabled for GitLab team members only.
...
1. In your IDE, select **GitLab Duo Agent Platform** ({{< icon name="duo-agentic-chat" >}}).
