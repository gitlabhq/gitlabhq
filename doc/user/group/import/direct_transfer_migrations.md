...
1. Review [user contribution](../../import/mapping/post_migration_mapping.md) and [user membership](#user-membership-mapping) mapping.
...
- Imported memberships are initially mapped to [placeholder users](../../import/mapping/post_migration_mapping.md#placeholder-users).
