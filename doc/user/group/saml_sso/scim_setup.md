...
1. Sign in to Okta.
1. In the upper-right corner, select **Admin**. If you've [turned on the new navigation](../../interface_redesign.md#turn-new-navigation-on-or-off), in the upper-right corner, select your avatar and then select **Admin**. The button is not visible from the **Admin** area.
