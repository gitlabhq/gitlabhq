...
| [`policy_warn_mode_approval_settings_overrides`](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/208969) | A warn-mode merge request approval policy sets more restrictive `approval_settings`. | {{< icon name="dotted-circle" >}} No | GitLab [18.6](https://gitlab.com/gitlab-org/gitlab/-/issues/563867) | Project |
