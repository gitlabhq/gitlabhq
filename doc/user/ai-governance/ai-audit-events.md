...
AI audit events are generated by the
[GitLab AI Gateway](../../administration/gitlab_duo/gateway.md). Agent sessions:

- On GitLab.com are routed through the GitLab.com-hosted AI Gateway, which forwards
  AI audit events to GitLab.com.
- On GitLab Self-Managed can be routed through the GitLab.com-hosted AI Gateway or
  through a self-managed [AI Gateway](../../install/install_ai_gateway.md). If you are
  managing your own AI Gateway, you must configure it forward AI audit events to your
  GitLab instance, otherwise no events are recorded in the dashboard.
