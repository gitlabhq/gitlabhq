...
1. On the left sidebar, at the top, select **Create new** ({{< icon name="plus" >}}) > **New project/repository**. If you've [turned on the new navigation](../../../interface_redesign.md), this button is in the upper-right corner.
