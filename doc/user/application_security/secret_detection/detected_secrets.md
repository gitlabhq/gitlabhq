...
| AWS Access Key ID                                 | AWS                                           | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
| AWS Access Secret Key                             | AWSSecretAccessKey                            | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="dotted-circle" >}} No |
| AWS Session Token                                 | AWSSessionToken                               | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
| AWS Cognito Identity Pool ID                      | AWSCognitoIdentityPoolID                      | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="dotted-circle" >}} No |
| AWS Bedrock Key                                   | AWSBedrockKey                       | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="dotted-circle" >}} No |
| AWS Bedrock Short-lived Key                       | AWSBedrockShortLivedKey                       | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
...
| Dropbox App Access Token                          | DropboxAppAccessToken                         | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
...
| Flutterwave Prod Encrypted Key                    | FlutterwaveProdEncryptedKey                   | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
...
| Flutterwave Prod Public Key                       | FlutterwaveProdPublicKey                      | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
...
| Flutterwave Prod Secret Key                       | FlutterwaveProdSecretKey                      | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
...
| Grafana Service Account Token                     | GrafanaServiceAccountToken                    | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
| Grafana Cloud Access Policy Token                 | GrafanaCloudAccessPolicyToken                 | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
...
| Heroku API key or application authorization token | Heroku API Key                                | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
...
| Intercom App Access Token                         | IntercomAppAccessToken                        | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
...
| Mapbox Secret API Token                           | MapboxSecretApiToken                          | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="dotted-circle" >}} No |
...
| OpenAI Project Key                                | OpenAiProjectKey                              | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
| OpenAI Service Account Key                        | OpenAiServiceAccountKey                       | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
...
| Postman Collection Access Key                     | PostmanCollectionAccessKey                    | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
...
| Shopify Partner API Token                         | ShopifyPartnerAPIToken                        | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
...
| Slack App Configuration Token                     | SlackAppConfigurationToken                    | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
| Slack App Configuration Refresh Token             | SlackAppConfigurationRefreshToken             | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
...
| Tailscale OAuth Client Secret                     | TailscaleOauthClientSecret                    | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
| Tailscale API Access Token                        | TailscaleApiAccessToken                       | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
| Tailscale Personal Auth Key                       | TailscalePersonalAuthKey                      | {{< icon name="check-circle" >}} Yes | {{< icon name="dotted-circle" >}} No | {{< icon name="check-circle" >}} Yes |
