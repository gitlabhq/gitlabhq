...
NOTE:
API security testing was named DAST API in GitLab 16.10 and earlier. CI/CD variables specific to API
Security Testing have **not** be renamed, and are still prefixed `DAST_API`. For more details, see
[merge request133238](https://gitlab.com/gitlab-com/www-gitlab-com/-/merge_requests/133238).

Perform Dynamic Application Security Testing (DAST) of web APIs to help discover bugs and potential
security issues that other QA processes may miss. Use API security testing tests and other
[GitLab Secure](../index.md) security scanners and your own test processes. You can run API security
testing either as part your CI/CD workflow, [on-demand](../dast/on-demand_scan.md), or both.
