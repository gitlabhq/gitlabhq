...
variable's content is a JSON snippet that provides headers and cookies to add to API security testing's
...
1. To validate that authentication is working, run a API security testing test and review the job logs
...
To validate that authentication is working, run a API security testing test and review the job logs and
...
To validate that authentication is working, run an API security testing test and review the job logs and the test API's application logs. See the [overrides section](#overrides) for more information about override commands.
