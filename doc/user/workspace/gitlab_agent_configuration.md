...
For example, if the path to your workspace project is `top-level-group/subgroup-1/subgroup-2/workspace-project`, you can use any configured agent for `top-level-group`, `subgroup-1`, or `subgroup-2` group.
