...
1. On the left sidebar, select **Search or go to** or use the <kbd>/</kbd> key to enable. If you've [turned on the new navigation](../interface_redesign.md), this field is on the top bar.
