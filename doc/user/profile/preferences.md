...
- On the left sidebar, select your avatar > select your name or username. If you've [turned on the new navigation](../interface_redesign.md), this button is in the upper-right corner.
