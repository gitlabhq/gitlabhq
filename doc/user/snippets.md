...
1. Select the kind of snippet you want to create:
   - To create a personal snippet, do one of the following:
     ...
     - From any other page: On the left sidebar, select **Create new** ({{< icon name="plus" >}}) and then **New snippet**. If you've [turned on the new navigation](interface_redesign.md), this button is in the upper-right corner.
