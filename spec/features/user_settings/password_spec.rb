...
RSpec.describe 'User Settings > Password', feature_category: :user_profile do
  ...
  describe 'Updating password' do
    ...
    context 'when password automatically set' do
    ...
    context 'when password authentication unavailable' do
      context 'with Regular user', :js do
        before do
          gitlab_sign_in(user)
        end
  ...
  describe 'Creating a new password' do
    before do
      sign_in(user)
      visit new_user_settings_password_path
    end

    context 'when password not automatically set' do
      ...
      def update_password(password, new_password)
        ...
        click_button _('Update password')
      end
    end
  end
end
