...
describe "Public Project Snippets Access", feature: true  do
  ...
  describe "GET /:project_path/snippets/:id" do
    context "for a public snippet" do
      subject { namespace_project_snippet_path(*project, public_snippet) }
    ...
    context "for an internal snippet" do
      subject { namespace_project_snippet_path(*project, internal_snippet) }
    ...
    context "for a private snippet" do
      subject { namespace_project_snippet_path(*project, private_snippet) }
  ...
  describe "GET /:project_path/snippets/:id/raw" do
    context "for a public snippet" do
      subject { raw_namespace_project_snippet_path(*project, public_snippet) }
    ...
    context "for an internal snippet" do
      subject { raw_namespace_project_snippet_path(*project, internal_snippet) }
    ...
    context "for a private snippet" do
      subject { raw_namespace_project_snippet_path(*project, private_snippet) }
