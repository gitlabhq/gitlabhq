...
feature 'Diff note avatars', feature: true, js: true do
  ...
  context 'commit view' do
    before do
      visit namespace_project_commit_path(*project, merge_request.commits.first.id)
    end
  ...
  %w(inline parallel).each do |view|
    context "#{view} view" do
      before do
        visit diffs_namespace_project_merge_request_path(*project, merge_request, view: view)
