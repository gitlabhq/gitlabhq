...
describe 'Filter merge requests', feature: true do
  ...
  describe 'filter by assignee id', js: true do
    it 'filter by current user' do
      visit namespace_project_merge_requests_path(*project, assignee_id: user.id)
    ...
    it 'filter by new user' do
      ...
      visit namespace_project_merge_requests_path(*project, assignee_id: new_user.id)
  ...
  describe 'filter by author id', js: true do
    it 'filter by current user' do
      visit namespace_project_merge_requests_path(*project, author_id: user.id)
    ...
    it 'filter by new user' do
      ...
      visit namespace_project_merge_requests_path(*project, author_id: new_user.id)
