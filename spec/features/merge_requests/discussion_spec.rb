    ...
    context 'active discussions' do
      it 'shows a link to the diff' do
        within(".discussion[data-discussion-id='#{active_discussion.id}']") do
          path = diffs_namespace_project_merge_request_path(*project, merge_request, anchor: active_discussion.line_code)
    ...
    context 'outdated discussions' do
      it 'shows a link to the outdated diff' do
        within(".discussion[data-discussion-id='#{outdated_discussion.id}']") do
          path = diffs_namespace_project_merge_request_path(*project, merge_request, diff_id: old_merge_request_diff.id, anchor: outdated_discussion.line_code)
