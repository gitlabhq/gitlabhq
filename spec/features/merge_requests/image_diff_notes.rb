...
feature 'Diff note avatars', js: true do
  ...
  context 'commit view', focus: true do
    ...
    describe 'render diff notes' do
      ...
      # Need to scope these notes to the diff
      let!(:note2) { create(:note_on_commit, commit_id: commit_id, project: project, position: :note2_position, note: 'my note 2') }
