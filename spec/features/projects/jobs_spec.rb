...
feature 'Jobs', :feature do
  ...
  describe "GET /:project/jobs" do
    ...
    context "Pending scope" do
      before do
        visit namespace_project_jobs_path(*project, scope: :pending)
      end
    ...
    context "Running scope" do
      before do
        job.run!
        visit namespace_project_jobs_path(*project, scope: :running)
      end
    ...
    context "Finished scope" do
      before do
        job.run!
        visit namespace_project_jobs_path(*project, scope: :finished)
      end
    ...
    context "All jobs" do
      before do
        ...
        visit namespace_project_jobs_path(*project)
      end
    ...
    context "when visiting old URL" do
      let(:jobs_url) do
        namespace_project_jobs_path(*project)
      end
  ...
  describe "GET /:project/jobs/:id" do
    context "Job from project" do
      ...
      before do
        visit namespace_project_job_path(*project, job)
      end
    ...
    context "Job from other project" do
      before do
        visit namespace_project_job_path(*project, job2)
      end
    ...
    context "when visiting old URL" do
      let(:job_url) do
        namespace_project_job_path(*project, job)
      end
  ...
  describe "GET /:project/jobs/:id/download" do
    ...
    context "Build from other project" do
      before do
        ...
        visit download_namespace_project_job_artifacts_path(*project, job2)
      end
  ...
  describe 'GET /:project/jobs/:id/raw', :js do
    context 'access source' do
      ...
      context 'job from other project' do
        before do
          Capybara.current_session.driver.headers = { 'X-Sendfile-Type' => 'X-Sendfile' }
          job2.run!
          visit raw_namespace_project_job_path(*project, job2)
        end
    ...
    context "when visiting old URL" do
      let(:raw_job_url) do
        raw_namespace_project_job_path(*project, job)
      end
  ...
  describe "GET /:project/jobs/:id/trace.json" do
    context "Job from project" do
      before do
        visit trace_namespace_project_job_path(*project, job, format: :json)
      end
    ...
    context "Job from other project" do
      before do
        visit trace_namespace_project_job_path(*project, job2, format: :json)
      end
  ...
  describe "GET /:project/jobs/:id/status" do
    context "Job from project" do
      before do
        visit status_namespace_project_job_path(*project, job)
      end
    ...
    context "Job from other project" do
      before do
        visit status_namespace_project_job_path(*project, job2)
      end
