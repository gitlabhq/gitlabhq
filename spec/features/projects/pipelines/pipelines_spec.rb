...
describe 'Pipelines', :feature, :js do
  ...
  context 'when user is logged in' do
    ...
    describe 'GET /:project/pipelines' do
      ...
      context 'with pagination' do
        ...
        it 'should render second page of pipelines' do
          visit namespace_project_pipelines_path(*project, page: '2')
          wait_for_requests
    ...
    describe 'GET /:project/pipelines/show' do
      ...
      before do
        ...
        visit namespace_project_pipeline_path(*project, pipeline)
        wait_for_requests
      end
    ...
    describe 'POST /:project/pipelines' do
      ...
      before do
        visit new_namespace_project_pipeline_path(*project)
      end
  ...
  def visit_project_pipelines(**query)
    visit namespace_project_pipelines_path(*project, query)
    wait_for_requests
  end
end
