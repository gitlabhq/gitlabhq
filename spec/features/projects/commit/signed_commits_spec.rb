...
RSpec.describe 'GPG signed commits', :js, feature_category: :source_code_management do
  ...
  context 'when shows popover badges' do
    ...
    it 'unverified signature: gpg key email does not match the committer_email but is the same user when the committer_email belongs to the user as a confirmed secondary email', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/issues/16791' do
      user_2_key
