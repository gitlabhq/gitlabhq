    ...
    context 'and an active deployment' do
      ...
      context 'when visiting a comparison for the branch' do
        before do
          ...
          visit namespace_project_compare_path(*project, from: 'master', to: branch_name)
      ...
      context 'when visiting a comparison for the commit' do
        before do
          ...
          visit namespace_project_compare_path(*project, from: 'master', to: sha)
      ...
      context 'when visiting a blob on the branch' do
        before do
          ...
          visit namespace_project_blob_path(*project, File.join(branch_name, file_path))
      ...
      context 'when visiting a blob on the commit' do
        before do
          ...
          visit namespace_project_blob_path(*project, File.join(sha, file_path))
      ...
      context 'when visiting the commit' do
        before do
          ...
          visit namespace_project_commit_path(*project, sha)
