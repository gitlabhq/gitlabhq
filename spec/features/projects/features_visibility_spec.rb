...
describe 'Edit Project Settings', feature: true do
  ...
  describe 'project features visibility selectors', js: true do
    ...
    context "pipelines subtabs" do
      it "shows builds when enabled" do
        visit namespace_project_pipelines_path(*project)
  ...
  describe 'project features visibility pages' do
    ...
    let(:tools) do
      {
        builds: namespace_project_job_path(*project, job),
        issues: namespace_project_issues_path(*project),
        wiki: namespace_project_wiki_path(*project, :home),
        snippets: namespace_project_snippets_path(*project),
        merge_requests: namespace_project_merge_requests_path(*project)
      }
    end
