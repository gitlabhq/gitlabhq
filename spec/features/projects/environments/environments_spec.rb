...
feature 'Environments page', :feature, :js do
    ...
    describe 'with one available environment' do
      ...
      describe 'in available tab page' do
        it 'should show one environment' do
          visit namespace_project_environments_path(*project, scope: 'available')
      ...
      describe 'in stopped tab page' do
        it 'should show no environments' do
          visit namespace_project_environments_path(*project, scope: 'stopped')
          expect(page).to have_css('.environments-container')
  ...
  def visit_environments(project)
    visit namespace_project_environments_path(*project)
  end
end
