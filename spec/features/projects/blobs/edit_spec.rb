...
feature 'Editing file blob', feature: true, js: true do
  ...
  context 'as a developer' do
    ...
    context 'from blob file path' do
      before do
        visit namespace_project_blob_path(*project, tree_join(branch, file_path))
        edit_and_commit
      end
  ...
  context 'visit blob edit' do
    context 'redirects to sign in and returns' do
      context 'as developer' do
        ...
        before do
          ...
          visit namespace_project_edit_blob_path(*project, tree_join(branch, file_path))
        end
        ...
        it 'redirects to sign in and returns' do
          ...
          expect(page).to have_current_path(namespace_project_edit_blob_path(*project, tree_join(branch, file_path)))
        end
      end
      ...
      context 'as guest' do
        ...
        it 'redirects to sign in and returns' do
          ...
          expect(page).to have_current_path(namespace_project_blob_path(*project, tree_join(branch, file_path)))
        end
      end
    end
    ...
    context 'as developer' do
      ...
      context 'with protected branch' do
        before do
          visit namespace_project_edit_blob_path(*project, tree_join(protected_branch, file_path))
        end
