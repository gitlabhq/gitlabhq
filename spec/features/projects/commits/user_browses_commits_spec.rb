...
RSpec.describe 'User browses commits', feature_category: :source_code_management do
  ...
  context 'when project_commits_refactor is enabled' do
    ...
    describe 'commits list' do
      ...
      # Filtered search, keyset pagination, CI status icons, signature badges,
      # slash refs, commit description expansion and the merge request button
      # are covered by the frontend integration suite in
      # ee/spec/frontend/integration/commits/.
