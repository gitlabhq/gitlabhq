...
feature 'Resolve an open discussion in a merge request by creating an issue', feature: true do
  ...
  describe 'As a user with access to the project' do
    ...
    it 'has a link to create a new issue for a discussion' do
      new_issue_link = new_namespace_project_issue_path(*project, discussion_to_resolve: discussion.id, merge_request_to_resolve_discussions_of: merge_request.iid)
    ...
    context 'creating the issue' do
      before do
        click_link 'Resolve this discussion in a new issue', href: new_namespace_project_issue_path(*project, discussion_to_resolve: discussion.id, merge_request_to_resolve_discussions_of: merge_request.iid)
      end
