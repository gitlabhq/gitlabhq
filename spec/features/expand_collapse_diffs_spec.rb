...
feature 'Expand and collapse diffs', js: true, feature: true do
  ...
  before do
    ...
    visit namespace_project_commit_path(*project, project.commit(branch))
  ...
  it 'should show the diff content with a highlighted line when linking to line' do
    ...
    visit namespace_project_commit_path(*project, project.commit(branch), anchor: "#{large_diff[:id]}_0_1")
  ...
  it 'should show the diff content when linking to file' do
    ...
    visit namespace_project_commit_path(*project, project.commit(branch), anchor: large_diff[:id])
    execute_script('window.location.reload()')
