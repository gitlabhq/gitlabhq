...
describe 'Copy as GFM', feature: true, js: true do
  ...
  describe 'Copying rendered GFM' do
    before do
      ...
      visit namespace_project_issue_path(*@project, @feat.issue)
    end
    ...
    it 'works', :aggregate_failures do
      ...
      verify(
        ...
        # issue URL
        namespace_project_issue_url(*@project, @feat.issue),
        # issue URL with note anchor
        namespace_project_issue_url(*@project, @feat.issue, anchor: 'note_123'),
        # issue link
        "[Issue](#{namespace_project_issue_url(*@project, @feat.issue)})",
        # issue link with note anchor
        "[Issue](#{namespace_project_issue_url(*@project, @feat.issue, anchor: 'note_123')})"
      )
  ...
  describe 'Copying code' do
    ...
    context 'from a blob' do
      before do
        visit namespace_project_blob_path(*project, File.join('master', 'files/ruby/popen.rb'))
        wait_for_requests
      end
    ...
    context 'from a GFM code block' do
      before do
        visit namespace_project_blob_path(*project, File.join('markdown', 'doc/api/users.md'))
        wait_for_requests
      end
