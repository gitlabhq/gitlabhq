...
describe 'Issues', feature: true do
  ...
  describe 'Issue info' do
    it 'excludes award_emoji from comment count' do
      ...
      visit namespace_project_issues_path(*project, assignee_id: user.id)
  ...
  describe 'Filter issue' do
    ...
    it 'allows filtering by issues with no specified assignee' do
      visit namespace_project_issues_path(*project, assignee_id: IssuableFinder::NONE)
  ...
  describe 'filter issue' do
    ...
    it 'sorts by newest' do
      visit namespace_project_issues_path(*project, sort: sort_value_recently_created)
    ...
    it 'sorts by oldest' do
      visit namespace_project_issues_path(*project, sort: sort_value_oldest_created)
    ...
    it 'sorts by most recently updated' do
      ...
      baz.save
      visit namespace_project_issues_path(*project, sort: sort_value_recently_updated)
    ...
    it 'sorts by least recently updated' do
      baz.updated_at = Time.now - 100
      baz.save
      visit namespace_project_issues_path(*project, sort: sort_value_oldest_updated)
    ...
    describe 'sorting by due date' do
      ...
      it 'sorts by recently due date' do
        visit namespace_project_issues_path(*project, sort: sort_value_due_date_soon)

        expect(first_issue).to include('foo')
      end

      it 'sorts by least recently due date' do
        visit namespace_project_issues_path(*project, sort: sort_value_due_date_later)
      ...
      context 'with a filter on labels' do
        ...
        it 'sorts by least recently due date by excluding nil due dates' do
          ...
          visit namespace_project_issues_path(*project, label_names: [label.name], sort: sort_value_due_date_later)
    ...
    describe 'filtering by due date' do
      ...
      it 'filters by none' do
        visit namespace_project_issues_path(*project, due_date: Issue::NoDueDate.name)
      ...
      it 'filters by any' do
        visit namespace_project_issues_path(*project, due_date: Issue::AnyDueDate.name)
      ...
      it 'filters by due this week' do
        ...
        visit namespace_project_issues_path(*project, due_date: Issue::DueThisWeek.name)
      ...
      it 'filters by due this month' do
        ...
        visit namespace_project_issues_path(*project, due_date: Issue::DueThisMonth.name)
      ...
      it 'filters by overdue' do
        ...
        visit namespace_project_issues_path(*project, due_date: Issue::Overdue.name)
    ...
    describe 'sorting by milestone' do
      ...
      it 'sorts by recently due milestone' do
        visit namespace_project_issues_path(*project, sort: sort_value_milestone_soon)
      ...
      it 'sorts by least recently due milestone' do
        visit namespace_project_issues_path(*project, sort: sort_value_milestone_later)
  ...
  describe 'update assignee from issue#show' do
    ...
    context 'by authorized user' do
      ...
      it 'allows user to select an assignee', js: true do
        ...
        visit namespace_project_issue_path(*project, issue2)
  ...
  describe 'new issue' do
    ...
    context 'by unauthenticated user' do
      ...
      it 'redirects to signin then back to new issue after signin' do
        ...
        expect(current_path).to eq new_namespace_project_issue_path(*project)
      end
    end
    ...
    context 'form filled by URL parameters' do
      ...
      before do
        ...
        visit new_namespace_project_issue_path(*project, issuable_template: 'bug')
      end
