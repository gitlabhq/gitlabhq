...
feature 'Member autocomplete', :js do
  ...
  context 'adding a new note on a Issue' do
    ...
    before do
      visit namespace_project_issue_path(*project, noteable)
    end
  ...
  context 'adding a new note on a Merge Request' do
    ...
    before do
      visit namespace_project_merge_request_path(*project, noteable)
    end
  ...
  context 'adding a new note on a Commit' do
    ...
    before do
      ...
      visit namespace_project_commit_path(*project, noteable)
    end
