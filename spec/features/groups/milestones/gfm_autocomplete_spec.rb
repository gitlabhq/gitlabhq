...
RSpec.describe 'GFM autocomplete', :js, feature_category: :markdown do
  ...
  let_it_be_with_reload(:user) { create(:user, name: '💃speciąl someone💃', username: 'someone.special') }
  ...
  let_it_be_with_reload(:issue) { create(:issue, project: project, assignees: [user], title: 'My special issue') }
