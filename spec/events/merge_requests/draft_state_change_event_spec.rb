...
require_relative '../../../app/events/merge_requests/draft_state_change_event'
require_relative '../../support/shared_examples/events/event_with_schema_shared_examples'

RSpec.describe MergeRequests::DraftStateChangeEvent, feature_category: :code_review_workflow do
