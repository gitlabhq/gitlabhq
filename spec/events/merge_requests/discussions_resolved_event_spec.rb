...
require_relative '../../../app/events/merge_requests/discussions_resolved_event'
require_relative '../../support/shared_examples/events/event_with_schema_shared_examples'

RSpec.describe MergeRequests::DiscussionsResolvedEvent, feature_category: :code_review_workflow do
