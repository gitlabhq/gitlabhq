...
require 'spec_helper'
require_relative '../../../app/events/merge_requests/after_create_cloud_event'
...
RSpec.describe MergeRequests::AfterCreateCloudEvent, feature_category: :code_suggestions do
