...
require_relative '../../../app/events/repositories/default_branch_changed_event'
require_relative '../../support/shared_examples/events/event_with_schema_shared_examples'

RSpec.describe Repositories::DefaultBranchChangedEvent, feature_category: :source_code_management do
