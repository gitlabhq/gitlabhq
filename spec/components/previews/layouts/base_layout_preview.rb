...
module Layouts
  class BaseLayoutPreview < ViewComponent::Preview
    # @param heading text
    ...
    def default(
      ...
      render(::Layouts::BaseLayout.new(heading: heading, description: description, loading: loading)) do
        tag.p('Base layout default slot.')
      end
    end

    def with_slots
      render(::Layouts::BaseLayout.new) do |c|
        c.with_heading do
    ...
    def with_alerts(
      ...
      render(::Layouts::BaseLayout.new(heading: heading, description: description, loading: loading)) do |c|
        c.with_alerts do
          c.safe_join([
    ...
    def page_heading_sr_only(
      ...
      render(::Layouts::BaseLayout.new(heading: heading, description: description, loading: loading,
