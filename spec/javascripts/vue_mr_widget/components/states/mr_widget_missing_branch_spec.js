...
describe('MRWidgetMissingBranch', () => {
  ...
  describe('template', () => {
    it('should have correct elements', () => {
      ...
      expect(el.innerText).toContain('source branch does not exist.');
      expect(el.innerText).toContain('Please restore the source branch or use a different source branch.');
    });
  });
});
