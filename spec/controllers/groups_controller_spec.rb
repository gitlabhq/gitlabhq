...
describe GroupsController do
  ...
  describe 'GET #issues' do
    ...
    before do
      create_list(:award_emoji, 3, awardable: issue_2, name: "thumbsup")
      create_list(:award_emoji, 2, awardable: issue_1, name: "thumbsup")
  ...
  describe 'GET #merge_requests' do
    ...
    before do
      create_list(:award_emoji, 3, awardable: merge_request_2, name: "thumbsup")
      create_list(:award_emoji, 2, awardable: merge_request_1, name: "thumbsup")
