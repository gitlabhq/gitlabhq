    ...
    describe "created from the new branch button on issues" do
      ...
      context 'repository-less project' do
        ...
        it 'redirects to newly created branch' do
          ...
          expect(response).to redirect_to namespace_project_tree_path(*project, branch)
        end
        ...
        it 'redirects to autodeploy setup page' do
          ...
          expect(response.location).to include(namespace_project_new_blob_path(*project, branch))
  ...
  describe "POST destroy" do
    ...
    context 'as HTML' do
      ...
      it 'redirects to branches path' do
        expect(response)
          .to redirect_to(namespace_project_branches_path(*project))
      end
    end
  end
  ...
  describe "DELETE destroy_all_merged" do
    ...
    context 'when user is allowed to push' do
      ...
      it 'redirects to branches' do
        ...
        expect(response).to redirect_to namespace_project_branches_path(*project)
      end
