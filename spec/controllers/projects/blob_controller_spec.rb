...
describe Projects::BlobController do
  ...
  describe 'GET edit' do
    ...
    context 'as guest' do
      ...
      it 'redirects to blob show' do
        expect(response).to redirect_to(namespace_project_blob_path(*project, 'master/CHANGELOG'))
      end
    end
  ...
  describe 'PUT update' do
    ...
    def blob_after_edit_path
      namespace_project_blob_path(*project, 'master/CHANGELOG')
    end
    ...
    context '?from_merge_request_iid' do
      ...
      it 'redirects to MR diff' do
        ...
        after_edit_path = diffs_namespace_project_merge_request_path(*project, merge_request)
    ...
    context 'when user has forked project' do
      ...
      context 'when editing on the fork' do
        ...
        it 'redirects to blob' do
          ...
          expect(response).to redirect_to(namespace_project_blob_path(*forked_project, 'master/CHANGELOG'))
        end
      end
