...
describe Projects::ProjectMembersController do
  ...
  describe 'GET index' do
    it 'should have the settings/members address with a 302 status code' do
      ...
      expect(response.location).to include namespace_project_settings_members_path(*project)
    end
  end
  ...
  describe 'POST create' do
    ...
    context 'when user has enough rights' do
      ...
      it 'adds user to members' do
        ...
        expect(response).to redirect_to(namespace_project_settings_members_path(*project))
      end
    ...
    context 'when member is found' do
      ...
      context 'and is a requester' do
        ...
        it 'removes user from members' do
          ...
          expect(response).to redirect_to(namespace_project_path(*project))
