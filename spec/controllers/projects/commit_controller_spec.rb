  ...
  describe 'POST revert' do
    ...
    context 'when the revert was successful' do
      it 'redirects to the commits page' do
        ...
        expect(response).to redirect_to namespace_project_commits_path(*project, 'master')
    ...
    context 'when the revert failed' do
      ...
      it 'redirects to the commit page' do
        ...
        expect(response).to redirect_to namespace_project_commit_path(*project, commit.id)
  ...
  describe 'POST cherry_pick' do
    ...
    context 'when the cherry_pick failed' do
      ...
      it 'redirects to the commit page' do
        ...
        expect(response).to redirect_to namespace_project_commit_path(*project, master_pickable_commit.id)
