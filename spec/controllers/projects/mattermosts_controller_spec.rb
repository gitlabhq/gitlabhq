  ...
  describe 'POST #create' do
    ...
    context 'no request can be made to mattermost' do
      it 'shows the error' do
        ...
        expect(subject).to redirect_to(new_namespace_project_mattermost_url(*project))
      end
    end
    ...
    context 'the request is succesull' do
      ...
      it 'redirects to the new page' do
        ...
        expect(subject).to redirect_to(edit_namespace_project_service_url(*project, service))
      end
    end
  end
end
