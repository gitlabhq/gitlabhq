...
RSpec.describe DuoDeveloperDotComMigration,
  migration: :gitlab_main_org,
  feature_category: :ai_abstraction_layer,
  migration_version: 20260826055250 do
    ...
    context 'when records with feature=16 exist' do
      ...
      let!(:source_record1) do
        namespace_feature_settings.create!(
          ...
          offered_model_ref: 'claude_sonnet_4_6_vertex',
          offered_model_name: 'Claude Sonnet 4.6',
          model_allowlist_enabled: true,
          model_allowlist_gitlab_model_refs: ['claude_sonnet_4_6_vertex'],
      ...
      it 'creates new records with feature=26 for each namespace' do
      ...
      it 'copies all attributes except feature and timestamps' do
        ...
        expect(new_record1).to have_attributes(
          ...
          model_allowlist_enabled: source_record1.model_allowlist_enabled,
          model_allowlist_gitlab_model_refs: source_record1.model_allowlist_gitlab_model_refs
        )
      ...
      context 'when target record already exists for a namespace' do
        ...
        it 'does not create a duplicate record for that namespace' do
          expect { migration.up }.to change { namespace_feature_settings.count }.by(2)
        end
  ...
  describe '#down' do
    ...
    it 'deletes all records with feature=26' do
