...
RSpec.describe ReviewMergeRequestDapDotComMigration,
  migration: :gitlab_main_org,
  feature_category: :ai_abstraction_layer,
  migration_version: 20260519120200 do
  ...
  describe '#up' do
    context 'when records with feature=15 exist' do
      let!(:namespace1) do
      ...
      it 'creates new records with feature=21 for each namespace' do
    ...
    context 'when no records with feature=15 exist' do
  ...
  describe '#down' do
    ...
    it 'deletes all records with feature=21' do
