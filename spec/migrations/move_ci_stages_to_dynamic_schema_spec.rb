...
RSpec.describe MoveCiStagesToDynamicSchema, :migration, feature_category: :continuous_integration do
    ...
    context 'when the partition exists in the dynamic schema' do
      before do
        ...
        ApplicationRecord.connection.execute(<<~SQL)
          CREATE TABLE IF NOT EXISTS #{identifier} PARTITION OF p_#{table_name} FOR VALUES IN (100, 101);
        SQL
      end
