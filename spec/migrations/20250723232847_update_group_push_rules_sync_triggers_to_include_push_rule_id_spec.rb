...
RSpec.describe UpdateGroupPushRulesSyncTriggersToIncludePushRuleId, feature_category: :source_code_management do
  ...
  describe '#up' do
    it 'creates a group_push_rules from push_rule with synced IDs' do
      ...
      expect(group_push_rules_table.last.id).to eq(push_rule.id)
  ...
  describe '#down' do
    it 'creates a group_push_rules from push_rule with out of sync IDs' do
      migrate_and_reset_registry_columns!
      schema_migrate_down!
