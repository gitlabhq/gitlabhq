...
RSpec.shared_examples Integrations::Base::MicrosoftTeams do
  ...
  describe "#execute" do
    ...
    context 'with push events' do
      ...
      it 'specifies the webhook when it is configured' do
        integration = double(:microsoft_teams_integration).as_null_object # rubocop:disable RSpec/ VerifiedDoubles -- legacy use
    ...
    context 'with work item events' do
      ...
      it "calls Microsoft Teams API for work item events" do
        chat_integration.execute(work_item_sample_data)
