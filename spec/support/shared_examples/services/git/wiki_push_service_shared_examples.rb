...
# -- None of the offenses are ActiveRecord calls
RSpec.shared_examples 'Git::WikiPushService' do |wiki_type|
  ...
  describe '#process_changes' do
    context 'when the push contains more than the permitted number of changes' do
      def run_service
    ...
    context 'when default_branch collides with a tag' do
    ...
    context 'when two pages have been created' do
      def run_service
        process_changes do
          write_new_page
          write_new_page
    ...
    context 'when a non-page file as been added' do
    ...
    context 'when one page, and one non-page have been created' do
      def run_service
        process_changes do
          write_new_page
          write_non_page
    ...
    context 'when one page has been added, and then updated' do
      def run_service
        process_changes do
