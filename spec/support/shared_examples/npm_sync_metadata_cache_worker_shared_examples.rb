...
RSpec.shared_examples 'does not enqueue a worker to sync a npm metadata cache' do
  it 'does not enqueue a worker to sync a npm metadata cache' do
...
RSpec.shared_examples 'enqueue a worker to sync a npm metadata cache' do
  before do
