...
RSpec.shared_examples 'group and projects packages resolver' do
  context 'without sort' do
    let_it_be(:npm_package, freeze: false) { create(:npm_package, project: project) }
