...
RSpec.shared_context 'for protected ref access' do
  let_it_be(:project, freeze: false) { create(:project, :public, :in_group) }
  ...
  let_it_be(:protected_ref, freeze: false) { create(protected_ref_name, default_access_level: false, project: project) }
end
