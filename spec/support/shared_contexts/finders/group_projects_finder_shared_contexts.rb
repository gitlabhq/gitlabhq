...
RSpec.shared_context 'GroupProjectsFinder context' do
  ...
  let_it_be(:public_project, freeze: false) { create(:project, :public, group: group, path: '1', name: 'g') }
  let_it_be(:private_project, freeze: false) { create(:project, :private, group: group, path: '2', name: 'f') }
  let_it_be(:shared_project_1, freeze: false) { create(:project, :public, path: '3', name: 'e') }
  let_it_be(:shared_project_2, freeze: false) { create(:project, :private, path: '4', name: 'd') }
  let_it_be(:shared_project_3, freeze: false) { create(:project, :internal, path: '5', name: 'c') }
  let_it_be(:subgroup_project, freeze: false) { create(:project, :public, path: '6', group: subgroup, name: 'b') }
  let_it_be(:subgroup_private_project, freeze: false) { create(:project, :private, path: '7', group: subgroup, name: 'a') }
  let_it_be(:root_group_public_project, freeze: false) { create(:project, :public, path: '8', group: root_group, name: 'root-public-project') }
