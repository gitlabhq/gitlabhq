...
RSpec.describe Packages::Maven::Metadata::SyncWorker, type: :worker do
  let_it_be_with_reload(:versionless_package_for_versions) { create(:maven_package, name: 'MyDummyMavenPkg', version: nil) }
  let_it_be_with_reload(:metadata_package_file) { create(:package_file, :xml, package: versionless_package_for_versions) }
  ...
  describe '#perform' do
    ...
    context 'with a maven plugin' do
      ...
      let_it_be_with_reload(:versionless_package_for_versions) { create(:maven_package, name: "#{versionless_package_name_for_plugins}/one-maven-plugin", version: nil) }
      let_it_be_with_reload(:metadata_package_file) { create(:package_file, :xml, package: versionless_package_for_versions) }
      ...
      let_it_be_with_reload(:metadata_package_file_for_plugins) { create(:package_file, :xml, package: versionless_package_for_plugins) }
