...
RSpec.describe ContainerExpirationPolicyWorker, feature_category: :container_registry do
  ...
  describe '#perform' do
    ...
    context 'when processing cleanups' do
    ...
    context 'when processing stale ongoing cleanups' do
      ...
      let_it_be_with_reload(:container_repository1) { create(:container_repository, :cleanup_scheduled) }
    ...
    context 'with policies without container repositories' do
      ...
      let_it_be_with_reload(:container_repository1) { create(:container_repository, project_id: container_expiration_policy1.project_id) }
