...
RSpec.describe Users::Calloutable, feature_category: :user_management do
  ...
  describe '#dismissed_after?' do
    ...
    it 'returns whether a callout dismissed after specified date' do
      expect(callout_dismissed_month_ago.dismissed_after?(15.days.ago)).to be(false)
      expect(callout_dismissed_day_ago.dismissed_after?(15.days.ago)).to be(true)
    end
  end
end
