...
RSpec.describe Gitlab::TenantContainerLifecycle::Stateful::TransitionContext, feature_category: :organization do
  ...
  describe '#transition_args' do
    it 'extracts args from transition' do
      ...
      result = organization.send(:transition_args, transition)
  ...
  describe '#transition_user' do
    it 'extracts transition_user from transition args' do
      ...
      result = organization.send(:transition_user, transition)
