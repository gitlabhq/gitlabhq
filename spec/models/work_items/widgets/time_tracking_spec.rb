...
RSpec.describe WorkItems::Widgets::TimeTracking, feature_category: :team_planning do
  let_it_be_with_reload(:work_item) { create(:work_item, time_estimate: 12.hours) }
  let_it_be_with_reload(:timelog1) { create(:timelog, issue: work_item, time_spent: 1.hour.to_i) }
