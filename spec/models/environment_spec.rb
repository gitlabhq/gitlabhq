...
RSpec.describe Environment, :use_clean_rails_memory_store_caching, :with_current_organization, feature_category: :environment_management do
  ...
  describe '.order_by_last_deployed_at' do
    let_it_be_with_reload(:project) { create(:project, :repository, organization: current_organization) }
  ...
  describe '.long_stopping' do
    ...
    let_it_be_with_reload(:project) { create(:project, organization: current_organization) }
