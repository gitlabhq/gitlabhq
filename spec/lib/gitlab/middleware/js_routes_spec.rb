...
RSpec.describe Gitlab::Middleware::JsRoutes, feature_category: :tooling do
  ...
  shared_examples 'path helpers are generated' do
  ...
  shared_examples 'path helpers are not generated' do
    it 'does not generate path helpers' do
  ...
  describe '#call' do
    ...
    context 'when routes have not changed since last call' do
      let(:current_digest) { Digest::SHA256.hexdigest("/test") }
