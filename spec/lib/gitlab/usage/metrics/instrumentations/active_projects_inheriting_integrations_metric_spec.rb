...
RSpec.describe Gitlab::Usage::Metrics::Instrumentations::ActiveProjectsInheritingIntegrationsMetric,
  ...
  let(:expected_query) do
    "SELECT COUNT(\"integrations\".\"id\") FROM \"integrations\" " \
      ...
      "AND \"integrations\".\"project_id\" IS NOT NULL " \
  ...
  before do
    ...
    create_list :pivotaltracker_integration, 3, inherit_from_id: integration.id
  end
