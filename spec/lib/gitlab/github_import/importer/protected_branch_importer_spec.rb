...
RSpec.describe Gitlab::GithubImport::Importer::ProtectedBranchImporter, feature_category: :importers do
  ...
  let_it_be_with_reload(:namespace_setting) { create(:namespace_settings, default_branch_protection_defaults: {}) }
  let_it_be_with_reload(:group) { create(:group, namespace_settings: namespace_setting) }
