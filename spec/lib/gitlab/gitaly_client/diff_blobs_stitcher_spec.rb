  ...
  describe 'enumeration' do
    it 'combines segregated diff blob messages together' do
      messages = [
        ...
        Message.new(
          left_blob_id: '8f2e9b1c4d7a3f5e6b0d2c8a9f1e3d5b7c4a6e8d',
          right_blob_id: '3a1d9c7b5f2e8d4a6c0b3e9f1d7a5c2b8e4f6a0',
          patch: 'b' * 100,
          status: :STATUS_END_OF_PATCH,
          binary: false,
          over_patch_bytes_limit: false
...
Message = Struct.new(:left_blob_id, :right_blob_id, :patch, :status, :binary, :over_patch_bytes_limit)
