...
RSpec.describe Gitlab::GitalyClient::ServerService, feature_category: :gitaly do
  ...
  describe '#server_signature' do
    it 'sends a server_signature message' do
      operation = instance_double(GRPC::ActiveCall::Operation, execute: [], trailing_metadata: {})
      ...
      expect_any_instance_of(Gitaly::ServerService::Stub).to receive(:server_signature).and_return(operation)
