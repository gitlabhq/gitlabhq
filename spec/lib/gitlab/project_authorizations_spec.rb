...
RSpec.describe Gitlab::ProjectAuthorizations, feature_category: :system_access do
  ...
  context 'user added to group and project' do
    ...
    let_it_be(:user) { owned_project.namespace.owner }
  ...
  context 'unapproved access request' do
    ...
    context 'shared project' do
      ...
      let_it_be(:shared_project) { create(:project, namespace: another_group) }
  ...
  context 'with nested groups' do
    ...
    context 'when the user is also a maintainer of the nested group' do
      before_all do
