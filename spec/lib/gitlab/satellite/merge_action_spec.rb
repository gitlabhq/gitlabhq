...
describe 'Gitlab::Satellite::MergeAction' do
  ...
  describe '#diffs_in_satellite tested against diff_in_satellite' do
    context 'on fork' do
      it 'should get proper diffs' do
        merge_request_fork.target_branch = @close_commit1[0]
        merge_request_fork.source_branch = @master[0]
        diffs = Gitlab::Satellite::MergeAction.new(merge_request_fork.author, merge_request_fork).diffs_in_satellite
    ...
    context 'between branches' do
      it 'should get proper diffs' do
        ...
        diffs = Gitlab::Satellite::MergeAction.new(merge_request.author, merge_request).diffs_in_satellite
