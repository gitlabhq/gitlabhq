  ...
  describe "with generic keyset order support" do
    ...
    describe '#sliced_nodes' do
      ...
      context 'when multiple orders with nil values are defined' do
        ...
        let_it_be(:project4, freeze: false) { create(:project, last_repository_check_at: nil) }            # Asc: project2  Desc: project2
      ...
      context 'when ordering by similarity' do
        let_it_be(:project1, freeze: false) { create(:project, name: 'test') }
        let_it_be(:project2, freeze: false) { create(:project, name: 'testing') }
        let_it_be(:project3, freeze: false) { create(:project, name: 'tests') }
