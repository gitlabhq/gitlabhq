...
RSpec.describe Gitlab::SidekiqMiddleware::ConcurrencyLimit::QueueManager,
  ...
  subject(:service) { described_class.new(worker_class_name, 'some_prefix') }
  ...
  describe '#resume_processing!' do
    ...
    let(:expected_context) do
      stored_context.merge(related_class: "Gitlab::SidekiqMiddleware::ConcurrencyLimit::QueueManager")
    end
