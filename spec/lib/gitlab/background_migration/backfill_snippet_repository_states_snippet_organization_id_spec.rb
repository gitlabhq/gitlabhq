...
RSpec.describe Gitlab::BackgroundMigration::BackfillSnippetRepositoryStatesSnippetOrganizationId,
  feature_category: :geo_replication,
  schema: 20260223183047 do
  include_examples 'desired sharding key backfill job' do
    ...
    let(:backfill_via_column) { :snippet_organization_id }
