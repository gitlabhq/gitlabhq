...
RSpec.describe Gitlab::BackgroundMigration::BackfillGroupWikiRepositoryLastUpdated, feature_category: :geo_replication do
  ...
  before do
    repo_with_commits = instance_double(Gitlab::Git::Repository, commit: commit)
    repo_empty = instance_double(Gitlab::Git::Repository, commit: nil)
    repo_missing = instance_double(Gitlab::Git::Repository, commit: nil)
