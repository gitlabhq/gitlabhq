...
RSpec.describe Gitlab::BackgroundMigration::RequeueBackfillRelatedEpicLinksToIssueLinks, feature_category: :team_planning do
  ...
  let!(:namespace) do
    table(:namespaces)
      .create!(name: 'my test group1', path: 'my-test-group1', organization_id: organization.id)
  end
