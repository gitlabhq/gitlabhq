...
RSpec.describe Gitlab::BackgroundMigration::BackfillMissingOrganizationIdOnCiRunnerMachines,
  ...
  describe '#perform' do
    ...
    let!(:project_runner1) { runners.create!(runner_type: 3, sharding_key_id: 10, organization_id: 1) }
    ...
    let!(:runner_manager3) { create_runner_manager(project_runner1, system_xid: 'a', organization_id: 1) }
    ...
    it 'backfills organization_id', :aggregate_failures do
      expect { perform_migration }
        ...
        .and not_change { runner_manager3.reload.organization_id }.from(described_class::DEFAULT_ORG_ID)
