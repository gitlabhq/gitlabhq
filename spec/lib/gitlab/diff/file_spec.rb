...
describe Gitlab::Diff::File, lib: true do
  ...
  describe '#content_changed?' do
    context 'when created' do
      ...
      context 'when not binary' do
        ...
        let(:diff_file) { commit.diffs.diff_file_with_new_path('files/images/wm.svg') }
    ...
    context 'when renamed' do
      ...
      before do
        allow(diff_file).to receive(:line_count).and_return(0)
      end
    ...
    context 'when content changed' do
      ...
      context 'when not binary' do
        ...
        context 'when not collapsed or too large' do
          it 'returns true' do
            expect(diff_file.content_changed?).to be_truthy
          end
        end
  ...
  describe '#simple_viewer' do
    context 'when the content changed' do
      ...
      context 'when the file represented by the diff file is not diffable' do
        before do
