...
RSpec.describe Security::CiConfiguration::DependencyScanningBuildAction, feature_category: :software_composition_analysis do
  ...
  shared_examples 'existing .gitlab-ci.yml tests' do
    context 'with existing .gitlab-ci.yml' do
      ...
      context 'when dependency scanning has not been included' do
        ...
        context 'when template includes are an array' do
        ...
        context 'when template include is not an array' do
          let(:gitlab_ci_content) do
            { "stages" => %w[test security],
              "variables" => { "RANDOM" => "make sure this persists" },
              "include" => { "template" => "existing.yml" } }
      ...
      context 'when dependency_scanning has been included' do
        ...
        context 'when dependency_scanning template include are an array' do
          let(:gitlab_ci_content) do
            { "stages" => %w[test],
              "variables" => { "RANDOM" => "make sure this persists" },
        ...
        context 'when dependency_scanning template include is not an array' do
          let(:gitlab_ci_content) do
            { "stages" => %w[test],
              "variables" => { "RANDOM" => "make sure this persists" },
              "include" => { "template" => "Security/Dependency-Scanning.gitlab-ci.yml" } }
