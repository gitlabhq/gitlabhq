...
describe ApplicationHelper do
  ...
  describe 'time_ago_with_tooltip' do
    ...
    it 'includes a default js-timeago class' do
      expect(element.attr('class')).to eq 'time-ago js-timeago js-timeago-pending'
    end

    it 'accepts a custom html_class' do
      expect(element(html_class: 'custom-class').attr('class')).
        to eq 'custom-class js-timeago js-timeago-pending'
    end
