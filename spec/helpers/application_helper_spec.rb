...
describe ApplicationHelper do
  ...
  describe "project_icon" do
    ...
    it "should return an url for the avatar" do
      ...
      project.save!
      project_icon(project.to_param).to_s.should == "/uploads/project/avatar/#{ project.id }/gitlab_logo.png"
    end

    it "should give default icon when no avatar is present" do
      project = create(:project)
      project.save!
      allow(self).to receive(:gravatar_icon).and_return('gravatar_method_called')
      project_icon(project.to_param).to_s.should == "/assets/no_avatar.png"
    end
  end
