...
import PipelinesDashboard from '~/ci/analytics/project_ci_cd_analytics/components/pipelines_dashboard.vue';
import DashboardHeader from '~/ci/analytics/project_ci_cd_analytics/components/dashboard_header.vue';
import ClickhouseHelpPopover from '~/ci/analytics/project_ci_cd_analytics/components/clickhouse_help_popover.vue';
import StatisticsList from '~/ci/analytics/project_ci_cd_analytics/components/statistics_list.vue';
import getPipelineCountByStatus from '~/ci/analytics/project_ci_cd_analytics/graphql/queries/get_pipeline_count_by_status.query.graphql';
import getProjectPipelineStatistics from '~/ci/analytics/project_ci_cd_analytics/graphql/queries/get_project_pipeline_statistics.query.graphql';
