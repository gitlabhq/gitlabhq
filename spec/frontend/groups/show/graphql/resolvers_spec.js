    ...
    expect(nodes).toEqual([
      {
        ...
        isSelfArchived: mockProject.is_self_archived,
      ...
      },
      {
        ...
        isSelfArchived: mockProject2.is_self_archived,
        ...
        children: [
          {
            ...
            path: mockSubproject.path,
            fullPath: mockSubproject.full_path,
            archived: mockSubproject.archived,
            isSelfArchived: mockSubproject.is_self_archived,
            ...
            children: [
              {
                ...
                path: mockNestedSubproject.path,
                fullPath: mockNestedSubproject.full_path,
                archived: mockNestedSubproject.archived,
                isSelfArchived: mockNestedSubproject.is_self_archived,
