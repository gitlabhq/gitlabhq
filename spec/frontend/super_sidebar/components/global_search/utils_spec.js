...
describe('getFormattedItem', () => {
  describe.each`
    ...
    ${{ category: WORK_ITEMS_CATEGORY }}                                                                              | ${SMALL_AVATAR_PX} | ${{ project: { id: 16, name: 'test16' } }} | ${16}        | ${'test16'}   | ${'recent_work_items'}
    ...
    ${{ category: WORK_ITEMS_CATEGORY, project_id: 17, project_name: 'test17' }}                                      | ${SMALL_AVATAR_PX} | ${null}                                    | ${17}        | ${'test17'}   | ${'recent_work_items'}
    ...
    ${{ category: WORK_ITEMS_CATEGORY, project_id: 18, project_name: 'test18' }}                                      | ${SMALL_AVATAR_PX} | ${{ project: { id: 16, name: 'test16' } }} | ${18}        | ${'test18'}   | ${'recent_work_items'}
