...
describe('generateText', () => {
  it.each`
    ...
    ${'%{same_start}Hello world%{same_end}'}                                   | ${'<span class="gl-font-bold gl-text-subtle">Hello world</span>'}
    ${'%{small_start}Hello world%{small_end}'}                                 | ${'<span class="gl-text-sm gl-text-subtle">Hello world</span>'}
