...
describe SystemNoteService, services: true do
        ...
        it "creates remote link" do
          ...
          expect(WebMock).to have_requested(:post, jira_api_remote_link_url(jira_issue)).with(
            body: hash_including(
              GlobalID: "GitLab",
              object: {
                url: namespace_project_commit_url(*project, commit),
        ...
        it "creates remote link" do
          ...
          expect(WebMock).to have_requested(:post, jira_api_remote_link_url(jira_issue)).with(
            body: hash_including(
              GlobalID: "GitLab",
              object: {
                url: namespace_project_issue_url(*project, issue),
        ...
        it "creates remote link" do
          ...
          expect(WebMock).to have_requested(:post, jira_api_remote_link_url(jira_issue)).with(
            body: hash_including(
              GlobalID: "GitLab",
              object: {
                url: namespace_project_snippet_url(*project, snippet),
  ...
  describe '.diff_discussion_outdated' do
    ...
    it 'links to the diff in the system note' do
      ...
      expect(subject.note).to include(diffs_namespace_project_merge_request_url(*project, merge_request, diff_id: diff_id, anchor: line_code))
    end
  end
end
