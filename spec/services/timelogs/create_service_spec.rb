...
RSpec.describe Timelogs::CreateService, feature_category: :team_planning do
  ...
  describe '#execute' do
    ...
    context 'when issuable is a MergeRequest' do
      let_it_be(:issuable, freeze: false) { create(:merge_request, source_project: project, source_branch: 'branch-1') }
    ...
    context 'when issuable is a WorkItem' do
      let_it_be(:issuable, freeze: false) { create(:work_item, project: project, title: 'WorkItem-1') }
    ...
    context 'when issuable is an Incident' do
      let_it_be(:issuable, freeze: false) { create(:incident, project: project) }
