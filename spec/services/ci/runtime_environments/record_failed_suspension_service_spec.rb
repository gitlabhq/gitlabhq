...
RSpec.describe Ci::RuntimeEnvironments::RecordFailedSuspensionService,
  ...
  context 'when suspend_on_failure is false' do
    let(:job_runtime_environment) do
      create(:ci_job_runtime_environment,
        build: build,
        runtime_environment: nil,
  ...
  context 'when environment_key is valid and suspend_on_failure is true' do
