  ...
  context 'when parent is a group' do
    ...
    context 'when the user can read the parent' do
      context 'when the user can update the work item' do
        ...
        it 'calls SystemDefined::WidgetDefinition.available_widgets' do
          expect(::WorkItems::TypesFramework::SystemDefined::WidgetDefinition)
            .to receive(:available_widgets).and_call_original
