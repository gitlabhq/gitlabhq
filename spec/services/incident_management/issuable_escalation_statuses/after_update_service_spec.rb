...
RSpec.describe IncidentManagement::IssuableEscalationStatuses::AfterUpdateService,
  ...
  let_it_be_with_reload(:escalation_status) { create(:incident_management_issuable_escalation_status, :triggered) }
  let_it_be_with_reload(:issue) { escalation_status.issue }
