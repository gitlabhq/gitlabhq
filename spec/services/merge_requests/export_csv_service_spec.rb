  ...
  describe 'csv_data' do
    ...
    describe 'assignees' do
      context 'when assigned' do
        let_it_be_with_reload(:merge_request) { create(:merge_request, assignees: create_list(:user, 2)) }
    ...
    describe 'merged user' do
      context 'MR is merged' do
        let_it_be_with_reload(:merge_request) { create(:merge_request, :merged, :with_merged_metrics) }
