...
<<<<<<< HEAD:spec/services/merge_requests/conflicts/resolve_service_spec.rb
=======
    def blob_content(project, ref, path)
      project.repository.blob_at(ref, path).data
    end

>>>>>>> abc61f260074663e5711d3814d9b7d301d07a259:spec/services/merge_requests/conflicts/resolve_service_spec.rb
