...
RSpec.describe Mcp::Tools::CreateIssueService, feature_category: :mcp_server do
  ...
  describe '#execute' do
    ...
    before do
      service.set_cred(access_token: oauth_token)
    end
    ...
    context 'with valid arguments' do
      ...
      context 'with project ID that needs encoding' do
        ...
        let(:arguments) { { arguments: { id: 'gitlab-org/gitlab', title: 'Test' } } }
    ...
    context 'with blank required field' do
      let(:arguments) { { arguments: { id: '', title: 'Test' } } }
    ...
    context 'with invalid title length' do
      let(:arguments) { { arguments: { id: 'test-project', title: '' } } }
    ...
    context 'with invalid path' do
      let(:arguments) { { arguments: { id: 'test-group/../admin/test-project', title: 'test issue' } } }
