...
RSpec.describe Labels::TransferService, feature_category: :team_planning do
  describe '#execute' do
    ...
    shared_examples 'label transfer service' do
    ...
    context 'when label_transfer_service_query_improvements FF is enabled' do
      it_behaves_like 'label transfer service'
    end

    context 'when label_transfer_service_query_improvements FF is disabled' do
      before do
        stub_feature_flags(label_transfer_service_query_improvements: false)
      end
