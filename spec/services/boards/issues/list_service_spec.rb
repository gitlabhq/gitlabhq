...
describe Boards::Issues::ListService, services: true do
  describe '#execute' do
    ...
    let(:p1) { create(:label, title: 'P1', subject: project, priority: 1) }
    let(:p2) { create(:label, title: 'P2', subject: project, priority: 2) }
    let(:p3) { create(:label, title: 'P3', subject: project, priority: 3) }
