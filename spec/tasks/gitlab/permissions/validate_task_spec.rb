    ...
    context 'when a permission is missing a definition file' do
      ...
      it 'returns an error' do
        expect { run }.to raise_error(SystemExit).and output(<<~OUTPUT).to_stdout
          ...
          #  Learn more: http://localhost/help/development/permissions/granular_access/rest_api_implementation_guide.md#step-3-create-permission-definition-files
          #
    ...
    context 'when a defined permission is not in the correct schema' do
      ...
      it 'returns an error' do
        expect { run }.to raise_error(SystemExit).and output(<<~OUTPUT).to_stdout
          ...
          #  Learn more: http://localhost/help/development/permissions/granular_access/rest_api_implementation_guide.md#complete-the-yaml-definition
          #
          #    - defined_permission
      ...
      context 'when the permission definition is not under a resource directory' do
        ...
        it 'returns an error' do
          expect { run }.to raise_error(SystemExit).and output(<<~OUTPUT).to_stdout
            ...
            #  Learn more: http://localhost/help/development/permissions/granular_access/rest_api_implementation_guide.md#permission-naming-and-validation
            #
      ...
      context 'when resource definition for the permission does not exist' do
        ...
        it 'returns an error' do
          expect { run }.to raise_error(SystemExit).and output(<<~OUTPUT).to_stdout
            ...
            #  Learn more: http://localhost/help/development/permissions/granular_access/rest_api_implementation_guide.md#create-resource-metadata-for-raw-permissions
            #
