...
RSpec.describe 'admin mode on tasks', :silence_stdout, feature_category: :system_access do
  before do
    allow(::Gitlab::Runtime).to receive_messages(test_suite?: false, rake?: true)
  end
