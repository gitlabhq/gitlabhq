...
describe 'cycle analytics events', api: true do
  ...
  describe 'GET /:namespace/:project/cycle_analytics/events/issues' do
    ...
    it 'lists the issue events' do
      get namespace_project_cycle_analytics_issue_path(*project, format: :json)
    ...
    it 'lists the plan events' do
      get namespace_project_cycle_analytics_plan_path(*project, format: :json)
    ...
    it 'lists the code events' do
      get namespace_project_cycle_analytics_code_path(*project, format: :json)
    ...
    it 'lists the test events' do
      get namespace_project_cycle_analytics_test_path(*project, format: :json)
    ...
    it 'lists the review events' do
      get namespace_project_cycle_analytics_review_path(*project, format: :json)
    ...
    it 'lists the staging events' do
      get namespace_project_cycle_analytics_staging_path(*project, format: :json)
    ...
    it 'lists the production events' do
      get namespace_project_cycle_analytics_production_path(*project, format: :json)
    ...
    context 'specific branch' do
      it 'lists the test events' do
        ...
        get namespace_project_cycle_analytics_test_path(*project, format: :json, branch: branch)
