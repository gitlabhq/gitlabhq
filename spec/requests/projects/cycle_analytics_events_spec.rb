...
describe 'cycle analytics events', api: true do
  ...
  describe 'GET /:namespace/:project/cycle_analytics/events/issues' do
    ...
    it 'lists the issue events' do
      ...
      first_issue_iid = project.issues.sort_by_attr(:created_desc).pluck(:iid).first.to_s
    ...
    it 'lists the plan events' do
      ...
      first_mr_short_sha = project.merge_requests.sort_by_attr(:created_asc).first.commits.first.short_id
    ...
    it 'lists the code events' do
      ...
      first_mr_iid = project.merge_requests.sort_by_attr(:created_desc).pluck(:iid).first.to_s
