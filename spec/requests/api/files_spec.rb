...
describe API::API, api: true  do
  ...
  describe "POST /projects/:id/repository/files" do
    ...
    it "should create a new file in project repo" do
      allow_any_instance_of(Gitlab::Satellite::NewFileAction).
  ...
  describe "PUT /projects/:id/repository/files" do
    ...
    it "should update existing file in project repo" do
      allow_any_instance_of(Gitlab::Satellite::EditFileAction).
        to receive(:commit!).and_return(true)
    ...
    it 'should return a 400 if the checkout fails' do
      allow_any_instance_of(Gitlab::Satellite::EditFileAction).
        to receive(:commit!).and_raise(Gitlab::Satellite::CheckoutFailed)
    ...
    it 'should return a 409 if the file was not modified' do
      allow_any_instance_of(Gitlab::Satellite::EditFileAction).
        to receive(:commit!).and_raise(Gitlab::Satellite::CommitFailed)
    ...
    it 'should return a 409 if the push fails' do
      allow_any_instance_of(Gitlab::Satellite::EditFileAction).
        to receive(:commit!).and_raise(Gitlab::Satellite::PushFailed)
