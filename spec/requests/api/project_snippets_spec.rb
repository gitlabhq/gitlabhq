...
describe API::API, api: true do
  ...
  describe 'GET /projects/:project_id/snippets/' do
    it 'all snippets available to team member' do
      ...
      public_snippet = create(:project_snippet, visibility_level: 20, project: project)
      internal_snippet = create(:project_snippet, visibility_level: 10, project: project)
      private_snippet = create(:project_snippet, visibility_level: 0, project: project)
    ...
    it 'hides private snippets from regular user' do
      project = create(:project, :public)
      user = create(:user)
      create(:project_snippet, visibility_level: 0, project: project)
