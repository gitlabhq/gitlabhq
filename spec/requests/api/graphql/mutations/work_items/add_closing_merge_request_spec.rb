...
RSpec.describe 'Add a closing merge request to a work item', feature_category: :team_planning do
  ...
  shared_examples 'a mutation that does not add closing merge requests' do
  ...
  shared_examples 'a mutation that adds closing merge requests' do
    context 'when the user cannot update the work item' do
      let(:current_user) { unauthorized_user }

      it_behaves_like 'a mutation that does not add closing merge requests'
    end
    ...
    context 'when the user can update the work item' do
      ...
      context 'when the target work item does not have a development widget' do
        ...
        it_behaves_like 'a mutation that does not add closing merge requests' do
  ...
  context 'when work item belongs to a project' do
    ...
    it_behaves_like 'a mutation that adds closing merge requests'
  end
