...
RSpec.describe 'Deleting a work item saved view', feature_category: :portfolio_management do
  ...
  it_behaves_like 'authorizing granular token permissions for GraphQL', :delete_work_item_saved_view do
