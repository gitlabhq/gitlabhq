...
RSpec.describe Tooling::Graphql::DeprecatedDocs::Renderer, feature_category: :api do
  let(:template) { Rails.root.join('tooling/graphql/deprecated_docs/templates/default.md.haml') }
