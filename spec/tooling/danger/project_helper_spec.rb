...
RSpec.describe Tooling::Danger::ProjectHelper, feature_category: :tooling do
  ...
  describe '#categories_for_file' do
    ...
    where(:path, :expected_categories) do
      ...
      # Database infrastructure specs (CODEOWNERS [Database] section)
      'spec/db/foo'                                                                    | [:database, :backend]
      'spec/db/foo/bar_spec.rb'                                                        | [:database, :backend]
      'ee/spec/db/foo'                                                                 | [:database, :backend]
      'ee/spec/db/foo/bar_spec.rb'                                                     | [:database, :backend]
      'jh/spec/db/foo'                                                                 | [:database, :backend]
      'spec/lib/gitlab/database_spec.rb'                                               | [:database, :backend]
      'spec/lib/gitlab/database/foo_spec.rb'                                           | [:database, :backend]
      'spec/lib/gitlab/database/foo/bar_spec.rb'                                       | [:database, :backend]
      'ee/spec/lib/gitlab/database_spec.rb'                                            | [:database, :backend]
      'ee/spec/lib/gitlab/database/foo_spec.rb'                                        | [:database, :backend]
      'ee/spec/lib/ee/gitlab/database_spec.rb'                                         | [:database, :backend]
      'ee/spec/lib/ee/gitlab/database/desired_sharding_key_spec.rb'                    | [:database, :backend]
      'spec/lib/gitlab/sql/foo_spec.rb'                                                | [:database, :backend]
      'spec/lib/gitlab/sql/foo/bar_spec.rb'                                            | [:database, :backend]
      'spec/lib/gitlab/database_helper.rb'                                             | [:backend]
      'spec/lib/gitlab/database_tasks_spec.rb'                                         | [:backend]
      ...
      'ee/app/models/ee/integrations/jira.rb' | [:project_management, :backend]
      'app/models/integrations/chat_message/pipeline_message.rb' | [:backend]
      'app/models/jira_connect_subscription.rb' | [:project_management, :backend]
      'app/models/hooks/service_hook.rb' | [:backend]
      'ee/app/models/ee/hooks/system_hook.rb' | [:backend]
      'app/services/concerns/integrations/project_test_data.rb' | [:backend]
      'ee/app/services/ee/integrations/test/project_service.rb' | [:backend]
      'app/controllers/concerns/integrations/actions.rb' | [:backend]
      'ee/app/controllers/concerns/ee/integrations/params.rb' | [:backend]
      'ee/app/controllers/projects/integrations/jira/issues_controller.rb' | [:project_management, :backend]
      'app/controllers/projects/hooks_controller.rb' | [:backend]
      'app/controllers/admin/hook_logs_controller.rb' | [:backend]
      'app/controllers/groups/settings/integrations_controller.rb' | [:backend]
      'app/controllers/jira_connect/branches_controller.rb' | [:project_management, :backend]
      'app/controllers/oauth/jira/authorizations_controller.rb' | [:project_management, :backend]
      'ee/app/finders/projects/integrations/jira/by_ids_finder.rb' | [:project_management, :database, :backend]
      'app/workers/jira_connect/sync_merge_request_worker.rb' | [:project_management, :backend]
      'app/workers/propagate_integration_inherit_worker.rb' | [:backend]
      'app/workers/web_hooks/log_execution_worker.rb' | [:backend]
      'app/workers/web_hook_worker.rb' | [:backend]
      'app/workers/project_service_worker.rb' | [:backend]
      'lib/atlassian/jira_connect/serializers/commit_entity.rb' | [:project_management, :backend]
      'lib/api/entities/project_integration.rb' | [:backend]
      'lib/gitlab/hook_data/note_builder.rb' | [:backend]
      'lib/gitlab/data_builder/note.rb' | [:backend]
      'lib/gitlab/slash_commands/run.rb' | [:backend]
      'lib/gitlab/web_hooks/recursion_detection.rb' | [:backend]
      'ee/lib/ee/gitlab/integrations/sti_type.rb' | [:backend]
      'ee/lib/ee/api/helpers/integrations_helpers.rb' | [:backend]
      'ee/app/serializers/integrations/jira_serializers/issue_entity.rb' | [:project_management, :backend]
      'app/serializers/jira_connect/app_data_serializer.rb' | [:project_management, :backend]
      'lib/api/github/entities.rb' | [:backend]
      'lib/api/v3/github.rb' | [:backend]
      ...
      'app/views/jira_connect/branches/new.html.haml' | [:project_management, :frontend]
      'app/views/layouts/jira_connect.html.haml' | [:project_management, :frontend]
      'app/assets/javascripts/jira_connect/branches/pages/index.vue' | [:project_management, :frontend]
      'ee/app/views/projects/integrations/jira/issues/show.html.haml' | [:project_management, :frontend]
      'ee/app/assets/javascripts/integrations/zentao/issues_list/graphql/queries/get_zentao_issues.query.graphql' | [:frontend]
      'app/assets/javascripts/pages/projects/settings/integrations/show/index.js' | [:frontend]
      'ee/app/assets/javascripts/pages/groups/hooks/index.js' | [:frontend]
    ...
    context 'when having specific changes' do
      where(:expected_categories, :patch, :changed_files) do
        ...
        [:database]                 | '+ add_column :integrations, :foo, :text'      | ['db/migrate/foo.rb']
        [:database]                 | '+ create_table :zentao_tracker_data do |t|'   | ['ee/db/post_migrate/foo.rb']
        [:backend]                  | '+ Integrations::Foo'                          | ['app/foo/bar.rb']
        [:backend]                  | '+ project.execute_hooks(foo, :bar)'           | ['ee/lib/ee/foo.rb']
        [:backend]                  | '+ project.execute_integrations(foo, :bar)'    | ['app/foo.rb']
