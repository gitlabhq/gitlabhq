...
RSpec.describe Tooling::Danger::ProjectHelper, feature_category: :tooling do
  ...
  describe '#categories_for_file' do
    ...
    where(:path, :expected_categories) do
      ...
      'ee/app/models/ee/integrations/jira.rb' | [:backend]
      'app/models/integrations/chat_message/pipeline_message.rb' | [:backend]
      'app/models/jira_connect_subscription.rb' | [:backend]
      ...
      'ee/app/controllers/projects/integrations/jira/issues_controller.rb' | [:backend]
      ...
      'app/controllers/jira_connect/branches_controller.rb' | [:backend]
      'app/controllers/oauth/jira/authorizations_controller.rb' | [:backend]
      'ee/app/finders/projects/integrations/jira/by_ids_finder.rb' | [:database, :backend]
      'app/workers/jira_connect/sync_merge_request_worker.rb' | [:backend]
      ...
      'lib/atlassian/jira_connect/serializers/commit_entity.rb' | [:backend]
      ...
      'ee/app/serializers/integrations/jira_serializers/issue_entity.rb' | [:backend]
      'app/serializers/jira_connect/app_data_serializer.rb' | [:backend]
      ...
      'app/views/jira_connect/branches/new.html.haml' | [:frontend]
      'app/views/layouts/jira_connect.html.haml' | [:frontend]
      'app/assets/javascripts/jira_connect/branches/pages/index.vue' | [:frontend]
      'ee/app/views/projects/integrations/jira/issues/show.html.haml' | [:frontend]
