...
(function (window, undefined) {
  ...
  function EpicEditor(options) {
    ...
    self._instanceId = 'epiceditor-main-element';// + Math.round(Math.random() * 100000);
    self._storage = {};
    self._canSave = true;
  ...
  EpicEditor.prototype.load = function (callback) {
    ...
    _HtmlTemplates = {
      ...
      chrome:   '<div id="epiceditor-wrapper" class="epiceditor-edit-mode">' +
                  ...
                  '<div id="epiceditor-utilbar">' +
                    '<img width="30" src="' + this.settings.basePath + '/assets/preview.png" title="Toggle Preview Mode" class="epiceditor-toggle-btn epiceditor-toggle-preview-btn"> ' +
                    '<img width="30" src="' + this.settings.basePath + '/assets/edit.png" title="Toggle Edit Mode" class="epiceditor-toggle-btn epiceditor-toggle-edit-btn"> ' +
                    '<img width="30" src="' + this.settings.basePath + '/assets/fullscreen.png" title="Enter Fullscreen" class="epiceditor-fullscreen-btn">' +
                  '</div>' +
                '</div>'
    ...
    self.element.innerHTML = '<iframe scrolling="no" frameborder="0" class="epiceditors-main-class" id= "' + self._instanceId + '" style="border-style:solid;border-radius:3px;border-width:1px;border-color:#ccc"></iframe>';
    ...
    // set the editor id
    self.editor.id = 'epiceditor-editor'
