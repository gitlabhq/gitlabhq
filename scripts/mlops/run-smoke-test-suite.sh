#!/usr/bin/env bash
#
# Run the MLOps smoke test suite.
#
# Usage: [ENV_VARS] ./scripts/mlops/run-smoke-test-suite.sh [--help|-h]
#
...
#
# Examples:
#   ONLY_RSPEC=1 ./scripts/mlops/run-smoke-test-suite.sh
#   SKIP_JEST=1 ./scripts/mlops/run-smoke-test-suite.sh
#
# Note on Rubocop:
