class Spinach::Features::ProjectGraph < Spinach::FeatureSteps
  ...
  When 'I visit project "Shop" graph page' do
    visit namespace_project_graph_path(*project, "master")
  end

  step 'I visit project "Shop" commits graph page' do
    visit commits_namespace_project_graph_path(*project, "master")
  end

  step 'I visit project "Shop" languages graph page' do
    visit languages_namespace_project_graph_path(*project, "master")
  end

  step 'I visit project "Shop" chart page' do
    visit charts_namespace_project_graph_path(*project, "master")
  end
  ...
  step 'I visit project "Shop" CI graph page' do
    visit ci_namespace_project_graph_path(*project, 'master')
  end
