...
class Spinach::Features::ProjectSourceMarkdownRender < Spinach::FeatureSteps
  ...
  step 'I should see files from repository in markdown' do
    expect(current_path).to eq namespace_project_tree_path(*@project, "markdown")
  ...
  step 'I should see correct document rendered' do
    expect(current_path).to eq namespace_project_blob_path(*@project, "markdown/doc/api/README.md")
    wait_for_requests
  ...
  step 'I should see correct directory rendered' do
    expect(current_path).to eq namespace_project_tree_path(*@project, "markdown/doc/raketasks")
  ...
  step 'I should see correct doc/api directory rendered' do
    expect(current_path).to eq namespace_project_tree_path(*@project, "markdown/doc/api")
    expect(page).to have_content "README.md"
  ...
  step 'I should see correct maintenance file rendered' do
    expect(current_path).to eq namespace_project_blob_path(*@project, "markdown/doc/raketasks/maintenance.md")
    wait_for_requests
  ...
  step 'I should see the correct document file' do
    expect(current_path).to eq namespace_project_blob_path(*@project, "markdown/doc/api/users.md")
  ...
  When 'I visit markdown branch' do
    visit namespace_project_tree_path(*@project, "markdown")
    wait_for_requests
  end

  When 'I visit markdown branch "README.md" blob' do
    visit namespace_project_blob_path(*@project, "markdown/README.md")
  end

  When 'I visit markdown branch "d" tree' do
    visit namespace_project_tree_path(*@project, "markdown/d")
  end

  When 'I visit markdown branch "d/README.md" blob' do
    visit namespace_project_blob_path(*@project, "markdown/d/README.md")
  end
  ...
  step 'The link with text "empty" should have url "tree/markdown"' do
    wait_for_requests
    find('a', text: /^empty$/)['href'] == current_host + namespace_project_tree_path(*@project, "markdown")
  end

  step 'The link with text "empty" should have url "blob/markdown/README.md"' do
    find('a', text: /^empty$/)['href'] == current_host + namespace_project_blob_path(*@project, "markdown/README.md")
  end

  step 'The link with text "empty" should have url "tree/markdown/d"' do
    find('a', text: /^empty$/)['href'] == current_host + namespace_project_tree_path(*@project, "markdown/d")
  end

  step 'The link with text "empty" should have '\
       'url "blob/markdown/d/README.md"' do
    find('a', text: /^empty$/)['href'] == current_host + namespace_project_blob_path(*@project, "markdown/d/README.md")
  end

  step 'The link with text "ID" should have url "tree/markdownID"' do
    find('a', text: /^#id$/)['href'] == current_host + namespace_project_tree_path(*@project, "markdown") + '#id'
  end
  ...
  step 'The link with text "README.mdID" '\
    ...
    find('a', text: /^README.md#id$/)['href'] == current_host + namespace_project_blob_path(*@project, "markdown/README.md") + '#id'
  end

  step 'The link with text "d/README.mdID" should have '\
       'url "blob/markdown/d/README.mdID"' do
    find('a', text: /^d\/README.md#id$/)['href'] == current_host + namespace_project_blob_path(*@project, "d/markdown/README.md") + '#id'
  end

  step 'The link with text "ID" should have url "blob/markdown/README.mdID"' do
    wait_for_requests
    find('a', text: /^#id$/)['href'] == current_host + namespace_project_blob_path(*@project, "markdown/README.md") + '#id'
  end
  ...
  step 'I go to wiki page' do
    click_link "Wiki"
    expect(current_path).to eq namespace_project_wiki_path(*@project, "home")
  end
  ...
  step 'I see new wiki page named test' do
    expect(current_path).to eq  namespace_project_wiki_path(*@project, "test")
  ...
  step 'I see Gitlab API document' do
    expect(current_path).to eq namespace_project_wiki_path(*@project, "api")
  ...
  step 'I see Rake tasks directory' do
    expect(current_path).to eq namespace_project_wiki_path(*@project, "raketasks")
  ...
  step 'I go directory which contains README file' do
    visit namespace_project_tree_path(*@project, "markdown/doc/api")
    expect(current_path).to eq namespace_project_tree_path(*@project, "markdown/doc/api")
  end
