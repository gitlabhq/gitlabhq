class Spinach::Features::ProjectCommits < Spinach::FeatureSteps
  ...
  step 'I visit commits list page for feature branch' do
    visit namespace_project_commits_path(*@project, 'feature', { limit: 5 })
  end
  ...
  step 'I should see button to the merge request' do
    ...
    expect(page).to have_link "View open merge request", href: namespace_project_merge_request_path(*@project, merge_request)
  end
  ...
  step 'I visit a commit with an image that changed' do
    visit namespace_project_commit_path(*@project, sample_image_commit.id)
  end
