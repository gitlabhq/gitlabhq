module SharedPaths
  ...
  step "I visit my project's files page" do
    visit namespace_project_tree_path(*@project, root_ref)
  end

  step 'I visit a binary file in the repo' do
    visit namespace_project_blob_path(*@project,
      File.join(root_ref, 'files/images/logo-black.png'))
  end

  step "I visit my project's commits page" do
    visit namespace_project_commits_path(*@project, root_ref, { limit: 5 })
  end

  step "I visit my project's commits page for a specific path" do
    visit namespace_project_commits_path(*@project, root_ref + "/app/models/project.rb", { limit: 5 })
  end

  step 'I visit my project\'s commits stats page' do
    visit stats_namespace_project_repository_path(*@project)
  end
  ...
  step "I visit my project's graph page" do
    ...
    visit namespace_project_network_path(*@project, root_ref)
  end
  ...
  step "I visit my project's members page" do
    visit namespace_project_project_members_path(*@project)
  end

  step "I visit my project's wiki page" do
    visit namespace_project_wiki_path(*@project, :home)
  end
  ...
  step 'I visit project deploy keys page' do
    visit namespace_project_deploy_keys_path(*@project)
  end

  step 'I visit project find file page' do
    visit namespace_project_find_file_path(*@project, root_ref)
  end
  ...
  step 'I visit project "Shop" activity page' do
    visit activity_namespace_project_path(*project)
  end

  step 'I visit project "Forked Shop" merge requests page' do
    visit namespace_project_merge_requests_path(*@forked_project)
  end
  ...
  step 'I visit project branches page' do
    visit namespace_project_branches_path(*@project)
  end

  step 'I visit project protected branches page' do
    visit namespace_project_protected_branches_path(*@project)
  end

  step 'I visit compare refs page' do
    visit namespace_project_compare_index_path(*@project)
  end
  ...
  step 'I visit project commits page for stable branch' do
    visit namespace_project_commits_path(*@project, 'stable', { limit: 5 })
  end
  ...
  step 'I visit blob file from repo' do
    visit namespace_project_blob_path(*@project, File.join(sample_commit.id, sample_blob.path))
  end

  step 'I visit ".gitignore" file in repo' do
    visit namespace_project_blob_path(*@project, File.join(root_ref, '.gitignore'))
  end

  step 'I am on the new file page' do
    expect(current_path).to eq(namespace_project_create_blob_path(*@project, root_ref))
  end

  step 'I am on the ".gitignore" edit file page' do
    expect(current_path).to eq(
      namespace_project_edit_blob_path(*@project, File.join(root_ref, '.gitignore')))
  end

  step 'I visit project source page for "6d39438"' do
    visit namespace_project_tree_path(*@project, "6d39438")
  end

  step 'I visit project source page for' \
       ' "6d394385cf567f80a8fd85055db1ab4c5295806f"' do
    visit namespace_project_tree_path(*@project,
                            '6d394385cf567f80a8fd85055db1ab4c5295806f')
  end

  step 'I visit project tags page' do
    visit namespace_project_tags_path(*@project)
  end
  ...
  step 'I visit issue page "Release 0.4"' do
    ...
    visit namespace_project_issue_path(*issue.project, issue)
  end

  step 'I visit project "Shop" labels page' do
    project = Project.find_by(name: 'Shop')
    visit namespace_project_labels_path(*project)
  end
  ...
  step 'I visit project "Shop" new label page' do
    project = Project.find_by(name: 'Shop')
    visit new_namespace_project_label_path(*project)
  end
  ...
  step 'I visit merge request page "Bug CO-01"' do
    ...
    visit namespace_project_merge_request_path(*mr.target_project, mr)
    wait_for_requests
  end
  ...
  def merge_request_path(title)
    ...
    namespace_project_merge_request_path(*mr.target_project, mr)
  end
