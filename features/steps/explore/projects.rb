class Spinach::Features::ExploreProjects < Spinach::FeatureSteps
  ...
  step 'I visit "Community" issues page' do
    ...
    visit namespace_project_issues_path(*public_project)
  end
  ...
  step 'I visit "Internal" issues page' do
    ...
    visit namespace_project_issues_path(*internal_project)
  end
  ...
  step 'I visit "Community" merge requests page' do
    visit namespace_project_merge_requests_path(*public_project)
  end
  ...
  step 'I visit "Internal" merge requests page' do
    visit namespace_project_merge_requests_path(*internal_project)
  end
