...
module TwCodeowners
  ...
  CODE_OWNER_RULES = [
    # CodeOwnerRule.new('Abuse Engineering', ''),
    # CodeOwnerRule.new('Accessibility', ''),
    # CodeOwnerRule.new('Acquisition', ''),
    # CodeOwnerRule.new('Activation', ''),
    CodeOwnerRule.new('Agent Developer', '@fneill'),
    CodeOwnerRule.new('Agent Execution', '@fneill'),
    CodeOwnerRule.new('Agent Foundations', '@fneill'),
    # CodeOwnerRule.new('Agentic Security Flows', ''),
    CodeOwnerRule.new('AI Catalog', '@fneill'),
    CodeOwnerRule.new('AI Coding', '@uchandran'),
    # CodeOwnerRule.new('AI Control Plane', ''),
    CodeOwnerRule.new('AI Core Infra', '@ashrafkhamis'),
    CodeOwnerRule.new('AI Framework', '@ashrafkhamis'),
    # CodeOwnerRule.new('AI Governance', ''),
    CodeOwnerRule.new('AI Model Services', '@ashrafkhamis'),
    CodeOwnerRule.new('AI Platform', '@ashrafkhamis'),
    # CodeOwnerRule.new('AI Security Research', ''),
    # CodeOwnerRule.new('Analytics Instrumentation', ''),
    CodeOwnerRule.new('API', '@idurham'),
    CodeOwnerRule.new('Async', '@axil'),
    CodeOwnerRule.new('Authentication', '@idurham'),
    CodeOwnerRule.new('Authorization', '@idurham'),
    # CodeOwnerRule.new('Billing Engine', ''),
    CodeOwnerRule.new('Build', '@axil @eread'),
    # CodeOwnerRule.new('Build Security', ''),
    ...
    # CodeOwnerRule.new('Cloud Cost Utilization', ''),
    CodeOwnerRule.new('Code Review', '@uchandran'),
    # CodeOwnerRule.new('Code Scanning', ''),
    # CodeOwnerRule.new('Code Security', ''),
    # CodeOwnerRule.new('Compliance', ''),
    # CodeOwnerRule.new('Composition Analysis', ''),
    CodeOwnerRule.new('Container Registry', '@z_painter'),
    # CodeOwnerRule.new('Context Systems', ''),
    CodeOwnerRule.new('Contributor Experience', '@eread'),
    CodeOwnerRule.new('Cost Management', '@lciutacu'),
    CodeOwnerRule.new('Custom Models', '@fneill'),
    CodeOwnerRule.new('DAP Events', '@uchandran'),
    CodeOwnerRule.new('DAP Repository Flows', '@uchandran'),
    # CodeOwnerRule.new('Database Architecture', ''),
    # CodeOwnerRule.new('Database Automation', ''),
    # CodeOwnerRule.new('Database Frameworks', ''),
    # CodeOwnerRule.new('Database Health', ''),
    # CodeOwnerRule.new('Database Operations', ''),
    # CodeOwnerRule.new('DataOps', ''),
    # CodeOwnerRule.new('Dedicated Hosted Runners', ''),
    # CodeOwnerRule.new('Dedicated Migrations', ''),
    ...
    CodeOwnerRule.new('Entitlements', '@lciutacu'),
    CodeOwnerRule.new('Environment Automation', '@lyspin'),
    # CodeOwnerRule.new('Environments', ''),
    # CodeOwnerRule.new('Events Platform', ''),
    # CodeOwnerRule.new('Fleet Management', ''),
    # CodeOwnerRule.new('Fulfillment Platform', ''),
    # CodeOwnerRule.new('Fuzz Testing', ''),
    # CodeOwnerRule.new('GATE Core', ''),
    # CodeOwnerRule.new('GATE Infra', ''),
    CodeOwnerRule.new('Geo', '@axil'),
    CodeOwnerRule.new('Git', '@eread'),
    CodeOwnerRule.new('Gitaly', '@eread'),
    CodeOwnerRule.new('GitLab Build', '@axil @eread'),
    # CodeOwnerRule.new('Global Search', ''),
    # CodeOwnerRule.new('Hosted Runners Platform', ''),
    ...
    # CodeOwnerRule.new('Networking and Incident Management', ''),
    # CodeOwnerRule.new('Observability', ''),
    # CodeOwnerRule.new('Observability, Monitoring, and Integrations', ''),
    ...
    # CodeOwnerRule.new('Performance Enablement', ''),
    ...
    CodeOwnerRule.new('Planning Views', '@brendan777'),
    # CodeOwnerRule.new('Platform and Infrastructure', ''),
    # CodeOwnerRule.new('Platform Insights', ''),
    # CodeOwnerRule.new('Policy Engine', ''),
    # CodeOwnerRule.new('Policy Management', ''),
    CodeOwnerRule.new('Portfolio Planning', '@brendan777'),
    CodeOwnerRule.new('Provision', '@lciutacu'),
    CodeOwnerRule.new('Purchase', '@lciutacu'),
    CodeOwnerRule.new('Redirect', 'Redirect'),
    # CodeOwnerRule.new('Release and Deploy', ''),
    # CodeOwnerRule.new('Remote Development', ''),
    CodeOwnerRule.new('Repository Services', '@brendan777'),
    # CodeOwnerRule.new('Respond', ''),
    CodeOwnerRule.new('Runner Core', '@rsarangadharan'),
    # CodeOwnerRule.new('Runners Platform', ''),
    # CodeOwnerRule.new('Runway', ''),
    CodeOwnerRule.new('Seat Management', '@lciutacu'),
    CodeOwnerRule.new('Secret Detection', '@rsarangadharan'),
    # CodeOwnerRule.new('Secrets Manager (Application)', ''),
    # CodeOwnerRule.new('Secrets Manager (OpenBAO)', ''),
    # CodeOwnerRule.new('Security Controls', ''),
    # CodeOwnerRule.new('Security Foundations', ''),
    ...
    CodeOwnerRule.new('Source Code Hardening & Modernization', '@brendan777'),
    CodeOwnerRule.new('Source Code Investigation', '@brendan777'),
    CodeOwnerRule.new('Source Code Triage', '@brendan777'),
    CodeOwnerRule.new('Spec-Driven Development', '@brendan777'),
    # CodeOwnerRule.new('Static Analysis', ''),
    CodeOwnerRule.new('Subscription Lifecycle', '@lciutacu'),
    ...
    # CodeOwnerRule.new('Test Governance', ''),
    CodeOwnerRule.new('Testing', '@eread'),
    # CodeOwnerRule.new('Threat Research', ''),
    # CodeOwnerRule.new('Transport', ''),
    # CodeOwnerRule.new('Trigger', ''),
    CodeOwnerRule.new('Tutorials', '@gl-docsteam'),
    CodeOwnerRule.new('US Public Sector Services', '@lyspin'),
    CodeOwnerRule.new('US PubSec', '@lyspin'),
    CodeOwnerRule.new('Usage Visibility', '@lciutacu'),
    CodeOwnerRule.new('Utilization', '@lciutacu'),
    # CodeOwnerRule.new('Vulnerability Management', ''),
    # CodeOwnerRule.new('Vulnerability Research', ''),
    CodeOwnerRule.new('Work Items', '@brendan777')
    # CodeOwnerRule.new('Workflow Catalog', ''),
    # CodeOwnerRule.new('Workflow Engine', '')
  ].freeze
...
namespace :tw do
  ...
  task :codeowners do
    ...
    Dir.glob(path) do |file|
      yaml_data = YAML.safe_load_file(file, permitted_classes: [Date])
