namespace :gitlab do
  ...
  def enable_namespaces
    ...
    puts "This will update your GitLab to be able to use namespaces for projects."
    puts "It will move projects in groups into appropriately named directories."
    puts "This will change their project and repo URLs."
    ask_to_continue
    puts ""
