...
module Backup
  ...
  class Options
    ...
    def serialize_skippables
      ...
      list << 'ci_catalog_bundles' if skippable_tasks.ci_catalog_bundles
    ...
    def extract_skippable_tasks(list)
      ...
      skippable_tasks.ci_catalog_bundles ||= list.include?('ci_catalog_bundles') # SKIP=ci_catalog_bundles
