  ...
  class AwardEmoji < Grape::API
    ...
    resource :projects do
      params do
        ...
        requires :awardable_id, type: Integer, desc: "The ID of an issue or MR"
      end
      AWARDABLES.each do |awardable_type|
        ...
        [ ":id/#{awardable_string}/:#{awardable_id_string}/award_emoji",
          ...
          params do
            requires :award_emoji_id, type: Integer, desc: 'The ID of an award emoji'
          end
          delete "#{endpoint}/:award_id" do
            award = awardable.award_emoji.find(params[:award_emoji_id])
