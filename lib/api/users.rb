...
module API
  class Users < ::API::Base
    ...
    resource :users, requirements: { uid: /[0-9]*/, id: /[0-9]*/ } do
      ...
      route_setting :authorization, permissions: :read_support_pin_user, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :revoke_support_pin_user, boundary_type: :standalone
      ...
      # rubocop: disable CodeReuse/ActiveRecord
      route_setting :authorization, permissions: :read_user, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :read_user_status, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :follow_user, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :unfollow_user, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :read_following_user, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :read_follower_user, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :create_user, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :update_user, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :disable_two_factor_authentication_user, boundary_type: :standalone
      ...
      # rubocop: disable CodeReuse/ActiveRecord
      route_setting :authorization, permissions: :delete_identity_user, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :read_project_deploy_key_user, boundary_type: :standalone
      ...
      # rubocop: disable CodeReuse/ActiveRecord
      route_setting :authorization, permissions: :create_user_ssh_key, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :read_user_ssh_key, boundary_type: :standalone
      ...
      # rubocop: disable CodeReuse/ActiveRecord
      route_setting :authorization, permissions: :delete_user_ssh_key, boundary_type: :standalone
      ...
      # rubocop: disable CodeReuse/ActiveRecord
      route_setting :authorization, permissions: :create_user_gpg_key, boundary_type: :standalone
      ...
      # rubocop: disable CodeReuse/ActiveRecord
      route_setting :authorization, permissions: :read_user_gpg_key, boundary_type: :standalone
      ...
      # rubocop: disable CodeReuse/ActiveRecord
      route_setting :authorization, permissions: :delete_user_gpg_key, boundary_type: :standalone
      ...
      # rubocop: disable CodeReuse/ActiveRecord
      route_setting :authorization, permissions: :revoke_user_gpg_key, boundary_type: :standalone
      ...
      # rubocop: disable CodeReuse/ActiveRecord
      route_setting :authorization, permissions: :create_user_email, boundary_type: :standalone
      ...
      # rubocop: disable CodeReuse/ActiveRecord
      route_setting :authorization, permissions: :read_user_email, boundary_type: :standalone
      ...
      # rubocop: disable CodeReuse/ActiveRecord
      route_setting :authorization, permissions: :delete_user_email, boundary_type: :standalone
      ...
      # rubocop: disable CodeReuse/ActiveRecord
      route_setting :authorization, permissions: :delete_user, boundary_type: :standalone
      ...
      # rubocop: disable CodeReuse/ActiveRecord
      route_setting :authorization, permissions: :activate_user, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :approve_user, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :reject_user, boundary_type: :standalone
      ...
      # rubocop: disable CodeReuse/ActiveRecord
      route_setting :authorization, permissions: :block_user, boundary_type: :standalone
      ...
      # rubocop: disable CodeReuse/ActiveRecord
      route_setting :authorization, permissions: :unblock_user, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :ban_user, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :unban_user, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :read_membership_user, boundary_type: :standalone
      ...
      resources ':id/associations_count' do
        ...
        route_setting :authorization, permissions: :read_association_user, boundary_type: :standalone
        get do
          authenticate!
      ...
      segment ':user_id' do
        resource :impersonation_tokens do
          ...
          route_setting :authorization, permissions: :read_impersonation_token_user, boundary_type: :standalone
          ...
          route_setting :authorization, permissions: :create_impersonation_token_user, boundary_type: :standalone
          ...
          route_setting :authorization, permissions: :delete_impersonation_token_user, boundary_type: :standalone
        ...
        resource :personal_access_tokens do
          ...
          route_setting :authorization, permissions: :create_user_personal_access_token, boundary_type: :standalone
          post feature_category: :system_access do
    ...
    resource :user do
      ...
      route_setting :authorization, permissions: :update_user_credit_card_validation, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :create_support_pin_user, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :update_user_preference, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :read_user_preference, boundary_type: :standalone
      ...
      # rubocop: disable CodeReuse/ActiveRecord
      route_setting :authorization, permissions: :read_activity_user, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :update_user_status, boundary_type: :standalone
      ...
      route_setting :authorization, permissions: :update_avatar_user, boundary_type: :standalone
