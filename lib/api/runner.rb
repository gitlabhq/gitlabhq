  ...
  class Runner < Grape::API
    ...
    resource :jobs do
      ...
      params do
        ...
        optional 'artifact_type', type: String, default: 'archive', values: Ci::JobArtifact.file_types.keys,
                                  desc: %q(Type of the artifact (`archive` or `junit`))
        optional 'artifact_format', type: String, default: 'zip', values: Ci::JobArtifact.file_formats.keys,
                                    desc: %q(Format of the artifact (`zip` or `gzip`))
      ...
      post '/:id/artifacts' do
        ...
        job.job_artifacts.build(
          ...
          artifact_format: artifact_format.to_sym,
