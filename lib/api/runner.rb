  ...
  class Runner < Grape::API
    ...
    resource :jobs do
      ...
      params do
        ...
        optional 'file_format', type: String, desc: %q(sha256 checksum of the file (generated by Workhorse))
        optional 'file_type', type: String, desc: %q(sha256 checksum of the file (generated by Workhorse))
