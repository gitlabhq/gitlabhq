...
module API
  class ProjectImport < ::API::Base
    ...
    resource :projects, requirements: ::API::NAMESPACE_OR_PROJECT_REQUIREMENTS do
      ...
      desc 'Import a project from a local archive' do
        detail 'Imports a project from a local archive.'
      ...
      desc 'Import a project from a remote archive' do
        detail 'Imports a project from a remote archive.'
        consumes ['multipart/form-data']
        tags ['project_import']
        success code: 201, model: Entities::ProjectImportStatus
        failure [
      ...
      params do
        ...
        requires :relation,
          type: String,
          values: ::Projects::ImportExport::RelationImportService::IMPORTABLE_RELATIONS,
          desc: 'The relation to import.'
        optional 'file.path', type: String, desc: 'Path to locally stored body (generated by Workhorse)'
      ...
      desc 'Import project resources' do
        detail 'Imports project resources included with a project archive. The type of item to import is controlled ' \
          'by the `relation` attribute. Skips items that were previously imported. This feature was introduced in ' \
          'GitLab 16.11.'
      ...
      desc 'Retrieve the status of a project resource import' do
        detail 'Retrieves the status of the most recent relation import for a specified project. Because only one ' \
          'relation import can be scheduled at a time, you can use this endpoint to check whether the previous ' \
          'import completed successfully. This feature was introduced in GitLab 16.11.'
        success code: 200, model: Entities::ProjectImportStatus
        failure [
          { code: 401, message: 'Unauthorized' },
          { code: 403, message: 'Forbidden' },
      ...
      desc 'Import a project from an AWS S3 bucket' do
        detail 'Imports a project from an archive stored in a specified AWS S3 bucket.'
        consumes ['multipart/form-data']
        tags ['project_import']
        success code: 201, model: Entities::ProjectImportStatus
        failure [
