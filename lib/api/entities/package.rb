...
module API
  module Entities
    class Package < Grape::Entity
      ...
      expose :creator_id,
        documentation: { type: 'Integer', format: 'int64', example: 1, desc: 'ID of the user who created the package' }
      expose :project_id, documentation: { type: 'Integer', format: 'int64', example: 2 }, if: ->(_, opts) {
        opts[:group]
      }
