...
module API
  module Entities
    class RemoteMirror < Grape::Entity
      ...
      expose :last_error, documentation: { type: 'String', example: 'The remote mirror URL is invalid.' }
      ...
      expose :ssh_known_hosts_fingerprints, as: :host_keys, using: ::API::Entities::MirrorHostKey,
        documentation: { type: '::API::Entities::MirrorHostKey', is_array: true }
    end
  end
end
