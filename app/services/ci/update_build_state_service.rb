  ...
  class UpdateBuildStateService
    ...
    def execute
      ...
      if build.waiting_for_runner_ack?
        ...
        return result unless result.status == 100 # Continue processing if returned HTTP 100 Continue
      end
    ...
    def handle_runner_ack_workflow
      ...
      when 'running'
        ...
        Result.new(status: 100) # Continue processing with update_build_state!
      else
