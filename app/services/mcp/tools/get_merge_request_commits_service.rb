...
module Mcp
  module Tools
    class GetMergeRequestCommitsService < ApiService
      extend ::Gitlab::Utils::Override

      # See: https://docs.gitlab.com/api/merge_requests/#get-single-mr-commits
      override :description
      def description
        'Get all commits associated with a merge request.'
      end
      ...
      def perform(arguments = {}, query = {})
        ...
        http_get(access_token, "/api/v4/projects/#{project_id}/merge_requests/#{merge_request_iid}/commits", query)
      end
