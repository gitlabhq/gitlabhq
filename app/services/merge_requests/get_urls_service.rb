module MergeRequests
  class GetUrlsService < BaseService
    ...
    def url_for_new_merge_request(branch_name)
      ...
      url = Gitlab::Routing.url_helpers.new_namespace_project_merge_request_url(*project, merge_request: merge_request_params)
      { branch_name: branch_name, url: url, new_merge_request: true }
    end

    def url_for_existing_merge_request(merge_request)
      target_project = merge_request.target_project
      url = Gitlab::Routing.url_helpers.namespace_project_merge_request_url(*target_project, merge_request)
