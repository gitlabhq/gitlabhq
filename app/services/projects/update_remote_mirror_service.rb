...
module Projects
  class UpdateRemoteMirrorService < BaseService
    ...
    # Memoized to ensure a single DNS resolution is shared between
    # validate_remote_url! and resolved_address.
    ...
    def resolved_address
      ...
      # resolved_host is nil when dns_rebind_protection is disabled (e.g. HTTP proxy),
      # meaning no IP resolution was performed and we should skip passing an address.
