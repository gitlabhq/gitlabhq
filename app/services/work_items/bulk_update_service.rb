  ...
  class BulkUpdateService
    ...
    def execute
      ...
      updated_work_items = scoped_work_items
        .includes(:project, :author, :dates_source, :assignees, namespace: [:route, :namespace_settings_with_ancestors_inherited_settings]).find_each(batch_size: 100) # rubocop:disable CodeReuse/ActiveRecord -- Implementation would be identical in model
