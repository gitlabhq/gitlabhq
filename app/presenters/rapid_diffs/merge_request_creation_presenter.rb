...
module RapidDiffs
  class MergeRequestCreationPresenter < BasePresenter
    ...
    def initialize(subject, project:, diff_view:, diff_options:, current_user: nil, request_params: nil)
      super(subject, diff_view:, diff_options:, current_user:, request_params:)
      @project = project
    end
