...
class Namespace < ApplicationRecord
  ...
  ignore_column :max_personal_access_token_lifetime, remove_with: '19.7', remove_after: '2026-11-13'
  ...
  after_update :schedule_sync_event_worker, if: -> { saved_change_to_organization_id? }
