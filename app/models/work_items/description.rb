...
module WorkItems
  class Description < ApplicationRecord
    ...
    belongs_to :root_namespace, class_name: 'Namespace'
    ...
    before_validation :set_namespace, :set_root_namespace
    ...
    def set_root_namespace
      return if work_item.nil?
      return if root_namespace == work_item.namespace.root_ancestor

      self.root_namespace = work_item.namespace.root_ancestor
    end
