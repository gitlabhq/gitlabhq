...
class ApplicationSetting < ApplicationRecord
  ...
  validates :default_search_scope,
    inclusion: {
      in: -> {
        ::Search::Scopes.all_scope_names + [SEARCH_SCOPE_SYSTEM_DEFAULT]
      },
  ...
  def self.rate_limits_definition
    {
      ...
      job_play_limit_per_user_project: [:integer, { default: 750 }],
      job_retry_limit_per_user_project: [:integer, { default: 1250 }],
      members_delete_limit: [:integer, { default: 60 }],
      create_organization_api_limit: [:integer, { default: 10 }],
      pipeline_cancel_limit_per_user_project: [:integer, { default: 120 }],
      pipeline_retry_limit_per_user_project: [:integer, { default: 200 }],
