...
class MergeRequest < ActiveRecord::Base
  ...
  def unmerged_diffs
     Gitlab::Satellite::MergeAction.new(author, self).diffs_in_satellite.map { |diff| Gitlab::Git::Diff.new(diff) }
  end
  ...
  def unmerged_commits
    #TODO [IA-7] fugly, maybe we can get the Gitlab:Git repo to do this...
