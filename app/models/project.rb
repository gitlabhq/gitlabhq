...
class Project < ActiveRecord::Base
  ...
  # which is not managed by the DB. Hence we're still using dependent: :destroy # rubocop:disable Cop/ActiveRecordDependent
  # here.
  ...
  # still using `dependent: :destroy` here. # rubocop:disable Cop/ActiveRecordDependent
