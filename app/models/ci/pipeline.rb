...
module Ci
  class Pipeline < Ci::ApplicationRecord
    ...
    def latest_test_report_builds_in_self_and_project_descendants
      latest_report_builds_in_self_and_project_descendants(Ci::JobArtifact.of_report_type(:test)).preload(:project, :metadata, :job_definition, :job_artifacts_archive, job_artifacts: :artifact_report)
    end
