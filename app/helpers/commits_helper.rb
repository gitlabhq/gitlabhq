module CommitsHelper
  ...
  def commit_branches_links(project, branches)
    branches.sort.map do |branch|
      link_to(project_ref_path(project, branch), class: "label label-gray ref-name commit-link") do
  ...
  def commit_tags_links(project, tags)
    ...
    sorted.map do |tag|
      link_to(project_ref_path(project, tag), class: "label label-gray ref-name commit-link") do
