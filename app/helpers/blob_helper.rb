module BlobHelper
  ...
  def copy_blob_source_button(blob)
    ...
    clipboard_button(target: ".blob-content[data-blob-id='#{blob.id}']", class: "btn btn-default btn-sm js-copy-blob-source-btn", title: "Copy source to clipboard")
  end
  ...
  def open_raw_blob_button(blob)
    ...
    link_to icon, blob_raw_path, class: 'btn btn-default btn-sm has-tooltip', target: '_blank', rel: 'noopener noreferrer', title: title, data: { container: 'body' }
  end
