module IssuablesHelper
  ...
  def issuable_json_path(issuable)
    ...
    if issuable.is_a?(MergeRequest)
      namespace_project_merge_request_path(*project, issuable.iid, :json)
    else
      namespace_project_issue_path(*project, issuable.iid, :json)
    end
  end
  ...
  def issuable_initial_data(issuable)
    data = {
      endpoint: namespace_project_issue_path(*@project, issuable),
  ...
  def issuable_todo_button_data(issuable, todo, is_collapsed)
    {
      ...
      url: namespace_project_todos_path(*@project),
