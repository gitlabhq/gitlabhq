module LabelsHelper
  ...
  def edit_label_path(label)
    ...
    when ProjectLabel then edit_namespace_project_label_path(*label.project, label)
    end
  end
  ...
  def destroy_label_path(label)
    ...
    when ProjectLabel then namespace_project_label_path(*label.project, label)
    end
  end
  ...
  def labels_filter_path
    ...
    if project
      namespace_project_labels_path(*project, :json)
    else
  ...
  def toggle_subscription_label_path(label, project)
    ...
    when 'project-level' then toggle_subscription_namespace_project_label_path(*project, label)
    when 'unsubscribed' then toggle_subscription_namespace_project_label_path(*project, label)
    end
  end
