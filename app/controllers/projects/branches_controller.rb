class Projects::BranchesController < Projects::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      format.html do
        if result[:status] == :success
          if redirect_to_autodeploy
            ...
            redirect_to namespace_project_tree_path(*@project, branch_name)
          end
        else
      ...
      format.json do
        if result[:status] == :success
          render json: { name: branch_name, url: namespace_project_tree_url(*@project, branch_name) }
        else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html do
        ...
        redirect_to namespace_project_branches_path(*@project), status: 303
      end
  ...
  def destroy_all_merged
    ...
    redirect_to namespace_project_branches_path(*@project),
