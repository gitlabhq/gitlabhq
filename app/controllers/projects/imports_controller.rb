class Projects::ImportsController < Projects::ApplicationController
  ...
  def create
    ...
    redirect_to namespace_project_import_path(*@project)
  end
  ...
  def show
    if @project.import_finished?
      if continue_params
        ...
        redirect_to namespace_project_path(*@project), notice: finished_notice
      end
    elsif @project.import_failed?
      redirect_to new_namespace_project_import_path(*@project)
    else
