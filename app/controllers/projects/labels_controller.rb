class Projects::LabelsController < Projects::ApplicationController
  ...
  def create
    ...
    if @label.valid?
      respond_to do |format|
        format.html { redirect_to namespace_project_labels_path(*@project) }
  ...
  def update
    ...
    if @label.valid?
      redirect_to namespace_project_labels_path(*@project)
    else
      render :edit
    end
  end
  ...
  def generate
    ...
    if params[:redirect] == 'issues'
      redirect_to namespace_project_issues_path(*@project)
