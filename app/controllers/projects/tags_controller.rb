class Projects::TagsController < Projects::ApplicationController
  ...
  def create
    ...
    if result[:status] == :success
      ...
      redirect_to namespace_project_tag_path(*@project, @tag.name)
    else
  ...
  def destroy
    ...
    respond_to do |format|
      if result[:status] == :success
        format.html do
          redirect_to namespace_project_tags_path(*@project), status: 303
        end
        ...
        format.html do
          redirect_to namespace_project_tags_path(*@project),
