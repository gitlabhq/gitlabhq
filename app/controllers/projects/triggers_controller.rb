class Projects::TriggersController < Projects::ApplicationController
  ...
  def index
    redirect_to namespace_project_settings_ci_cd_path(*@project)
  end
  ...
  def update
    if trigger.update(trigger_params)
      redirect_to namespace_project_settings_ci_cd_path(*@project), notice: 'Trigger was successfully updated.'
    else
      render action: "edit"
    end
  end
  ...
  def destroy
    ...
    redirect_to namespace_project_settings_ci_cd_path(*@project), status: 302
  end
