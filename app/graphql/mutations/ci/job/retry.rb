  ...
  module Ci
    module Job
      class Retry < Base
        ...
        authorize :retry_job
        authorize_granular_token permissions: :retry_job, boundary_argument: :id, boundary: :project,
        ...
        def resolve(id:, variables:, inputs:)
          ...
          response = ::Ci::RetryJobService.new(job.project, current_user).execute(
            job, variables: variables, inputs: inputs
          )
