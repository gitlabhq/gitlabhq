...
module Types
  class TodoActionEnum < BaseEnum
    ...
    value 'approval_required', value: 5, description: 'User is eligible to approve a merge request.'
    ...
    value 'added_approver', value: 13, description: 'User is eligible to approve a merge request.'
