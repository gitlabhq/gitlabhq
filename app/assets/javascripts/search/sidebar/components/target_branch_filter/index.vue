...
import { autocompleteMergeRequestTargetBranchesPath } from '~/lib/utils/path_helpers/autocomplete';
...
export default {
  ...
  methods: {
    ...
    getMergeRequestTargetBranchesEndpoint() {
      const endpoint = autocompleteMergeRequestTargetBranchesPath({ format: 'json' });
