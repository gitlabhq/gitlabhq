<script>
  import nextDiscussionIcon from '../icons/next_discussion.svg';
  ...
  export default {
    ...
    methods: {
      jumpToNextUnresolvedDiscussion() {
        ...
        const discussionIdsForElements = (elements) => {
    ...
    created() {
      this.nextDiscussionIcon = nextDiscussionIcon;
    }
  };
</script>
...
<template>
  <div class="btn-group"
    ...
    v-if="showButton">
    <button type="button"
      class="btn btn-default discussion-next-btn has-tooltip"
      @click="jumpToNextUnresolvedDiscussion"
      :title="buttonText"
      :aria-label="buttonText"
      data-container="body"
      v-html="nextDiscussionIcon">
    </button>
  </div>
</template>
