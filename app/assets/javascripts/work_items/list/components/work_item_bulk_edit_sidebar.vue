...
import workItemBulkUpdateMutation from '../graphql/work_item_bulk_update.mutation.graphql';
import getAvailableBulkEditWidgets from '../graphql/get_available_bulk_edit_widgets.query.graphql';
...
const WorkItemBulkEditIteration = () =>
  import('ee_component/work_items/list/components/work_item_bulk_edit_iteration.vue');
