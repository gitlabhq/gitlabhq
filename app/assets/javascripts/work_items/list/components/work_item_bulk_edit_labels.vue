...
import { debounce, intersectionBy, unionBy, uniqueId } from 'lodash-es';
...
import { findLabelsWidget, formatLabelForListbox } from '~/work_items/utils';

export default {
  name: 'WorkItemBulkEditLabels',
  components: {
    GlButton,
