...
<template>
  <div class="gl-flex gl-flex-col gl-gap-4">
    <section>
      ...
      <div v-if="glSlots()['admin-content']" :class="$options.contentClass">
        <slot name="admin-content"></slot>
      </div>
      <ul v-if="glSlots()['admin-list']" :class="$options.listClass">
    ...
    <section>
      ...
      <div v-if="glSlots()['group-content']" :class="$options.contentClass">
        <slot name="group-content"></slot>
      </div>
      <ul v-if="glSlots()['group-list']" :class="$options.listClass">
    ...
    <section>
      ...
      <div v-if="glSlots()['settings-content']" :class="$options.contentClass">
        <slot name="settings-content"></slot>
      </div>
      <ul v-if="glSlots()['settings-list']" :class="$options.listClass">
