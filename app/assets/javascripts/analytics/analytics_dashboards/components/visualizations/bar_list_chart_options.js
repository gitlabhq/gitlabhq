...
// colour, so a blue bar list matches the other GLQL charts' first series; gray marks a
// baseline shown next to a coloured list.
export const BAR_COLOR_ORANGE = 'orange';
export const BAR_COLOR_BLUE = 'blue';
export const BAR_COLOR_GRAY = 'gray';
export const BAR_COLOR_OPTIONS = [BAR_COLOR_ORANGE, BAR_COLOR_BLUE, BAR_COLOR_GRAY];
...
export const BAR_COLOR_TOKENS = {
  ...
  [BAR_COLOR_GRAY]: GL_COLOR_NEUTRAL_400,
};
