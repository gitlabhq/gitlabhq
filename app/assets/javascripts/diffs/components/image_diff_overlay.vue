...
<template>
  <div class="position-absolute image-diff-overlay gl-h-full gl-w-full">
    <button
      v-if="canComment"
      type="button"
      class="btn-transparent position-absolute image-diff-overlay-add-comment js-add-image-diff-note-button gl-h-full gl-w-full"
