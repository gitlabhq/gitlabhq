...
requireAll(require.context('./behaviors',  false, /^\.\/.*\.js$/));
requireAll(require.context('./blob',       false, /^\.\/.*\.js$/));
requireAll(require.context('./templates',  false, /^\.\/.*\.js$/));
requireAll(require.context('./commit',     false, /^\.\/.*\.js$/));
requireAll(require.context('./extensions', false, /^\.\/.*\.js$/));
requireAll(require.context('./lib/utils',  false, /^\.\/.*\.js$/));
requireAll(require.context('./u2f',        false, /^\.\/.*\.js$/));
requireAll(require.context('./droplab',    false, /^\.\/.*\.js$/));
requireAll(require.context('.',            false, /^\.\/(?!application\.js).*\.js$/));
