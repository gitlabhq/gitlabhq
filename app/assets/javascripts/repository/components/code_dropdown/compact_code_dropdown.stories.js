import CompactCodeDropdown from './compact_code_dropdown.vue';

export default {
  component: CompactCodeDropdown,
  title: 'repository/code_dropdown/compact_code_dropdown',
};

const Template = (args, { argTypes }) => ({
  components: { CompactCodeDropdown },
  props: Object.keys(argTypes),
  template: '<CompactCodeDropdown v-bind="$props" />',
});
