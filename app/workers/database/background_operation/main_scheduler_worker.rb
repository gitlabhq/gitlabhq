...
module Database # rubocop:disable Gitlab/BoundedContexts -- This is the best place for this module
  module BackgroundOperation
    class MainSchedulerWorker < BaseSchedulerWorker # rubocop:disable Scalability/IdempotentWorker -- parent has it
      ...
      def self.orchestrator_class
        Database::BackgroundOperation::MainOrchestratorWorker
      end
    end
  end
end
