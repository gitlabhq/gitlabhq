...
# Optional environment variables: DELETE_BEFORE (default: 3 days ago)
...
module QA
  module Tools
    class DeleteTestSnippets < DeleteResourceBase
      # @example delete snippets older than 3 days for the user associated with the given access token
