...
module QA
  RSpec.describe 'Create', feature_category: :source_code_management do
    describe 'SSH key support' do
      ...
      it 'pushes code to the repository via SSH', :smoke, :health_check, :skip_fips_env, :skip_cells do
      ...
      it 'pushes multiple branches and tags together', :smoke, :health_check, :skip_fips_env, :skip_cells do
        branches = []
        tags = []
