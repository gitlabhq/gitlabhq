  ...
  feature 'push code to repository', :core do
    context 'with regular account over http' do
      ...
      scenario 'user pushes code to a protected branch' do
        ...
        Page::Project::Show.act { go_to_settings }
        Page::Project::Settings::Menu.act { go_to_repository }

        Scenario::Gitlab::Project::Settings::Repository::ProtectBranch.perform do |scenario|
          scenario.action = :protect
          scenario.branch = 'protected'
        end
