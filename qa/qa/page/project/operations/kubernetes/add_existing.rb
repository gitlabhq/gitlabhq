        ...
        module Kubernetes
          class AddExisting < Page::Base
            view 'app/views/projects/clusters/user/_form.html.haml' do
              element :cluster_name, 'text_field :cluster_name'
              element :api_url, 'text_field :cluster_platform_kubernetes_attributes_api_url'
              element :ca_certificate, 'text_field :cluster_platform_kubernetes_attributes_ca_cert'
              element :token, 'text_field :cluster_platform_kubernetes_attributes_token'
