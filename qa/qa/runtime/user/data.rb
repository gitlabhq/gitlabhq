  ...
  module Runtime
    module User
      ...
      module Data
        ...
        ADMIN_USERNAME_VARIABLE = "GITLAB_ADMIN_USERNAME"
        # @return [String] default username for admin user
        DEFAULT_ADMIN_USERNAME = "root"
        # @return [String] admin password variable name
        ADMIN_PASSWORD_VARIABLE = "GITLAB_ADMIN_PASSWORD"
        # @return [String] default password for admin user
        DEFAULT_ADMIN_PASSWORD = "5iveL!fe"

        # @return [String] global test user api token
        TEST_USER_API_TOKEN_VARIABLE = "GITLAB_QA_ACCESS_TOKEN"
        # @return [String] global test user username
        TEST_USER_USERNAME_VARIABLE = "GITLAB_USERNAME"
        # @return [String] global test user password
        TEST_USER_PASSWORD_VARIABLE = "GITLAB_PASSWORD"

        # Admin user username
        #
        # @return [String]
        def admin_username
          @admin_username ||= admin_variable_with_default("username", ADMIN_USERNAME_VARIABLE, DEFAULT_ADMIN_USERNAME)
        end
        ...
        # @return [String]
        def admin_password
          @admin_password ||= admin_variable_with_default("password", ADMIN_PASSWORD_VARIABLE, DEFAULT_ADMIN_PASSWORD)
        end
        ...
        def test_user_username
          ENV[TEST_USER_USERNAME_VARIABLE]
        end
        ...
        def test_user_password
          ENV[TEST_USER_PASSWORD_VARIABLE]
        end
        ...
        def test_user_api_token
          ENV[TEST_USER_API_TOKEN_VARIABLE]
        end
