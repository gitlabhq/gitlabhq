...
ActiveRecord::Schema.define(version: 20160309140734) do
  ...
  add_index "ci_runners", ["description"], name: "index_ci_runners_on_description_trigram", using: :gin
  add_index "ci_runners", ["token"], name: "index_ci_runners_on_token_trigram", using: :gin
  ...
  add_index "issues", ["description"], name: "index_issues_on_description_trigram", using: :gin
  add_index "issues", ["milestone_id"], name: "index_issues_on_milestone_id", using: :btree
  add_index "issues", ["project_id", "iid"], name: "index_issues_on_project_id_and_iid", unique: true, using: :btree
  add_index "issues", ["project_id"], name: "index_issues_on_project_id", using: :btree
  add_index "issues", ["state"], name: "index_issues_on_state", using: :btree
  add_index "issues", ["title"], name: "index_issues_on_title", using: :btree
  add_index "issues", ["title"], name: "index_issues_on_title_trigram", using: :gin
  ...
  add_index "merge_requests", ["description"], name: "index_merge_requests_on_description_trigram", using: :gin
  ...
  add_index "merge_requests", ["title"], name: "index_merge_requests_on_title_trigram", using: :gin
  ...
  add_index "milestones", ["description"], name: "index_milestones_on_description_trigram", using: :gin
  add_index "milestones", ["due_date"], name: "index_milestones_on_due_date", using: :btree
  add_index "milestones", ["project_id", "iid"], name: "index_milestones_on_project_id_and_iid", unique: true, using: :btree
  add_index "milestones", ["project_id"], name: "index_milestones_on_project_id", using: :btree
  add_index "milestones", ["title"], name: "index_milestones_on_title", using: :btree
  add_index "milestones", ["title"], name: "index_milestones_on_title_trigram", using: :gin
  ...
  add_index "namespaces", ["name"], name: "index_namespaces_on_name_trigram", using: :gin
  add_index "namespaces", ["owner_id"], name: "index_namespaces_on_owner_id", using: :btree
  add_index "namespaces", ["path"], name: "index_namespaces_on_path", unique: true, using: :btree
  add_index "namespaces", ["path"], name: "index_namespaces_on_path_trigram", using: :gin
  ...
  add_index "notes", ["note"], name: "index_notes_on_note_trigram", using: :gin
  ...
  add_index "projects", ["description"], name: "index_projects_on_description_trigram", using: :gin
  add_index "projects", ["last_activity_at"], name: "index_projects_on_last_activity_at", using: :btree
  add_index "projects", ["name"], name: "index_projects_on_name_trigram", using: :gin
  add_index "projects", ["namespace_id"], name: "index_projects_on_namespace_id", using: :btree
  add_index "projects", ["path"], name: "index_projects_on_path", using: :btree
  add_index "projects", ["path"], name: "index_projects_on_path_trigram", using: :gin
  ...
  add_index "snippets", ["file_name"], name: "index_snippets_on_file_name_trigram", using: :gin
  add_index "snippets", ["project_id"], name: "index_snippets_on_project_id", using: :btree
  add_index "snippets", ["title"], name: "index_snippets_on_title_trigram", using: :gin
  ...
  add_index "users", ["email"], name: "index_users_on_email_trigram", using: :gin
  add_index "users", ["name"], name: "index_users_on_name", using: :btree
  add_index "users", ["name"], name: "index_users_on_name_trigram", using: :gin
  add_index "users", ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true, using: :btree
  add_index "users", ["username"], name: "index_users_on_username", using: :btree
  add_index "users", ["username"], name: "index_users_on_username_trigram", using: :gin
