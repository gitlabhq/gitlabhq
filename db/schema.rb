...
ActiveRecord::Schema.define(version: 20170608171156) do
  ...
  add_index "merge_request_diff_files", ["merge_request_diff_id", "relative_order"], name: "index_merge_request_diff_files_on_mr_diff_id_and_order", using: :btree
  ...
  add_foreign_key "merge_request_diff_files", "merge_request_diffs", name: "fk_501aa0a391", on_delete: :cascade
