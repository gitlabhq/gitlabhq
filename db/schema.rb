...
ActiveRecord::Schema.define(version: 20160210105555) do
  ...
  add_index "ci_builds", ["gl_project_id", "status", "type"], name: "index_ci_builds_on_gl_project_id_and_status_and_type", using: :btree
  add_index "ci_builds", ["gl_project_id", "status"], name: "index_ci_builds_on_gl_project_id_and_status", using: :btree
  add_index "ci_builds", ["gl_project_id", "type"], name: "index_ci_builds_on_gl_project_id_and_type", using: :btree
  add_index "ci_builds", ["gl_project_id"], name: "index_ci_builds_on_gl_project_id", using: :btree
  add_index "ci_builds", ["project_id", "commit_id"], name: "index_ci_builds_on_project_id_and_commit_id", using: :btree
  add_index "ci_builds", ["project_id"], name: "index_ci_builds_on_project_id", using: :btree
  add_index "ci_builds", ["runner_id"], name: "index_ci_builds_on_runner_id", using: :btree
  add_index "ci_builds", ["status"], name: "index_ci_builds_on_status", using: :btree
  add_index "ci_builds", ["type", "status", "runner_id"], name: "index_ci_builds_on_test2", using: :btree
  ...
  add_index "emails", ["email"], name: "emails_email_key", unique: true, using: :btree
  add_index "emails", ["user_id"], name: "index_emails_on_user_id", using: :btree

  create_table "events", force: :cascade do |t|
    t.string   "target_type", limit: 510
    t.integer  "target_id"
  ...
  add_index "forked_project_links", ["forked_to_project_id"], name: "forked_project_links_forked_to_project_id_key", unique: true, using: :btree
  ...
  create_table "issues", force: :cascade do |t|
    ...
    t.string   "branch_name",   limit: 510
    t.text     "description"
  ...
  create_table "keys", force: :cascade do |t|
    ...
    t.string   "fingerprint", limit: 510
    t.boolean  "public",                  default: false, null: false
  end
  ...
  create_table "merge_requests", force: :cascade do |t|
    t.string   "target_branch",             limit: 510,                 null: false
    t.string   "source_branch",             limit: 510,                 null: false
    ...
    t.integer  "milestone_id"
    t.string   "state",                     limit: 510
    t.string   "merge_status",              limit: 510
  ...
  create_table "namespaces", force: :cascade do |t|
    ...
    t.string   "path",                  limit: 510,                 null: false
    t.integer  "owner_id"
    t.datetime "created_at",                                        null: false
    t.datetime "updated_at",                                        null: false
    t.string   "type",                  limit: 510
  ...
  create_table "notes", force: :cascade do |t|
    t.text     "note"
    t.string   "noteable_type", limit: 510
    t.integer  "author_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "project_id"
    t.string   "attachment",    limit: 510
    t.string   "line_code",     limit: 510
    t.string   "commit_id",     limit: 510
  ...
  create_table "projects", force: :cascade do |t|
    ...
    t.boolean  "issues_enabled",                                                             null: false
    t.boolean  "wall_enabled",                                                               null: false
    t.boolean  "merge_requests_enabled",                                                     null: false
    t.boolean  "wiki_enabled",                                                               null: false
    t.integer  "namespace_id"
    t.string   "issues_tracker",                              limit: 510, default: "gitlab", null: false
    t.string   "issues_tracker_id",                           limit: 510
    t.boolean  "snippets_enabled",                                                           null: false
    t.datetime "last_activity_at"
    t.string   "import_url",                                  limit: 510
    ...
    t.text     "pages_custom_certificate"
    t.text     "pages_custom_certificate_key"
    t.string   "pages_custom_certificate_key_iv"
    t.string   "pages_custom_certificate_key_salt"
    t.string   "pages_custom_domain"
    t.boolean  "pages_redirect_http",                                     default: false,    null: false
    t.text     "encrypted_pages_custom_certificate_key"
    t.string   "encrypted_pages_custom_certificate_key_iv"
    t.string   "encrypted_pages_custom_certificate_key_salt"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "skype",                       limit: 510, default: "",    null: false
    t.string   "linkedin",                    limit: 510, default: "",    null: false
    t.string   "twitter",                     limit: 510, default: "",    null: false
    t.string   "authentication_token",        limit: 510
    t.integer  "theme_id",                                default: 1,     null: false
    t.string   "bio",                         limit: 510
    t.integer  "failed_attempts",                         default: 0
    t.datetime "locked_at"
    t.string   "username",                    limit: 510
    t.boolean  "can_create_group",                                        null: false
    t.boolean  "can_create_team",                                         null: false
    t.string   "state",                       limit: 510
    ...
    t.boolean  "hide_no_ssh_key"
    t.string   "website_url",                 limit: 510, default: "",    null: false
  ...
  create_table "web_hooks", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "type",                    limit: 510,  default: "ProjectHook"
    t.integer  "service_id"
    t.boolean  "push_events",                                                  null: false
    t.boolean  "issues_events",                                                null: false
    t.boolean  "merge_requests_events",                                        null: false
