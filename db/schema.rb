...
ActiveRecord::Schema.define(version: 20180917172041) do
  ...
  create_table "merge_request_diffs", force: :cascade do |t|
    ...
    t.index ["id"], name: "tmp_partial_diff_id_with_files_index", where: "((state)::text <> ALL (ARRAY[('without_files'::character varying)::text, ('empty'::character varying)::text]))", using: :btree
