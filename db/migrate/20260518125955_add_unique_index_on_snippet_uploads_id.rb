...
class AddUniqueIndexOnSnippetUploadsId < Gitlab::Database::Migration[2.3]
  disable_ddl_transaction!

  milestone '19.1'

  PARTITION_TABLE_NAME = :snippet_uploads
  PARTITION_INDEX_NAME = :idx_snippet_uploads_on_id
