...
# snippet_user_mentions.snippet_organization_id is copied from snippets.organization_id,
...
class RemoveOrganizationFkFromSnippetUserMentions < Gitlab::Database::Migration[2.3]
  milestone '19.4'

  disable_ddl_transaction!

  CONSTRAINT_NAME = 'fk_def441dfc3'

  def up
    with_lock_retries do
      remove_foreign_key_if_exists :snippet_user_mentions, :organizations,
  ...
  def down
    add_concurrent_foreign_key :snippet_user_mentions, :organizations,
