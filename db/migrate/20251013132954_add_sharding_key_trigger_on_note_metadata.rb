...
class AddShardingKeyTriggerOnNoteMetadata < Gitlab::Database::Migration[2.3]
  include Gitlab::Database::SchemaHelpers

  FUNCTION_NAME = 'sync_sharding_key_with_notes_table'
  TRIGGER_NAME = 'set_sharding_key_for_note_metadata_on_insert_and_update'
  ...
  def up
    ...
    create_trigger(:note_metadata, TRIGGER_NAME, FUNCTION_NAME, fires: 'BEFORE INSERT OR UPDATE')
  end

  def down
    drop_trigger(:note_metadata, TRIGGER_NAME)
  end
end
