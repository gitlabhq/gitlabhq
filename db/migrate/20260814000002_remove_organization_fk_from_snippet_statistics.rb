...
# snippet_statistics.snippet_organization_id is copied from snippets.organization_id,
...
class RemoveOrganizationFkFromSnippetStatistics < Gitlab::Database::Migration[2.3]
  milestone '19.4'

  disable_ddl_transaction!

  CONSTRAINT_NAME = 'fk_73a34da7d8'

  def up
    with_lock_retries do
      remove_foreign_key_if_exists :snippet_statistics, :organizations,
  ...
  def down
    add_concurrent_foreign_key :snippet_statistics, :organizations,
