...
class AddConcurrentIndexToShardingKeyColumnsOnClusterProvidersAws < Gitlab::Database::Migration[2.3]
  disable_ddl_transaction!
  milestone '18.9'

  TABLE_NAME = 'cluster_providers_aws'

  ORGANIZATION_INDEX = 'idx_cluster_providers_aws_on_organization_id'
  GROUP_INDEX = 'idx_cluster_providers_aws_on_group_id'
  PROJECT_INDEX = 'idx_cluster_providers_aws_on_project_id'
