...
class AddBigintFkForDeploymentMergeRequestsToDeployments < Gitlab::Database::Migration[2.3]
  ...
  def up
    ...
    # fk_rails_dcbce9f4df on the bigint shadow column, so it introduces no new dependent records
