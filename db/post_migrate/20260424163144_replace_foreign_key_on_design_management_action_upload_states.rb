...
class ReplaceForeignKeyOnDesignManagementActionUploadStates < Gitlab::Database::Migration[2.3]
  disable_ddl_transaction!

  milestone '19.0'

  SOURCE_TABLE_NAME = :design_management_action_upload_states
  NEW_TARGET_TABLE = :design_management_action_uploads
  OLD_TARGET_TABLE = :uploads_archived
  COLUMN = :design_management_action_upload_id
  OLD_FOREIGN_KEY_NAME = :fk_f51f732561
  NEW_FOREIGN_KEY_NAME = :fk_rails_f51f732561
