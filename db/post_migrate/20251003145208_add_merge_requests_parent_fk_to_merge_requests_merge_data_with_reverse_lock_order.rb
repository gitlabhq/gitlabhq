...
class AddMergeRequestsParentFkToMergeRequestsMergeDataWithReverseLockOrder < Gitlab::Database::Migration[2.3]
  ...
  def down
    ...
    with_lock_retries do
      remove_foreign_key_if_exists TABLE_NAME, column: :merge_request_id, reverse_lock_order: true
    end
  end
end
