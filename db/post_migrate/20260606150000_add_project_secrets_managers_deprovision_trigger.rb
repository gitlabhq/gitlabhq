...
class AddProjectSecretsManagersDeprovisionTrigger < Gitlab::Database::Migration[2.3]
  include Gitlab::Database::SchemaHelpers

  milestone '19.2'

  FUNCTION_NAME = 'enqueue_psm_deprovision_task'
  TRIGGER_NAME = 'enqueue_psm_deprovision_task_after_delete'
  ...
  def down
    drop_trigger(:project_secrets_managers, TRIGGER_NAME)
