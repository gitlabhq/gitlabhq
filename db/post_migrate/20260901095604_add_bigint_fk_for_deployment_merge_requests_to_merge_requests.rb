...
class AddBigintFkForDeploymentMergeRequestsToMergeRequests < Gitlab::Database::Migration[2.3]
  ...
  def up
    ...
    # fk_rails_86a6d8bf12 on the bigint shadow column, so it introduces no new dependent records
