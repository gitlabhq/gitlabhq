...
class AddFkAiAuditEventsToProjects < Gitlab::Database::Migration[2.3]
  ...
  # `ai_audit_events.project_id` to `projects.id` using
  ...
  # GitLab.com `projects` table and was marked as skipped via ChatOps.
  #
  ...
  # `db/post_migrate/20260505183631_remove_projects_ai_audit_events_project_id_fk.rb`.
  def up
    # No-op
  end
