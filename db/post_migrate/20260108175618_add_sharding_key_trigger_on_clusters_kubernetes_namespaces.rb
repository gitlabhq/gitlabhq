...
class AddShardingKeyTriggerOnClustersKubernetesNamespaces < Gitlab::Database::Migration[2.3]
  milestone '18.9'
  include Gitlab::Database::SchemaHelpers

  TABLE_NAME = 'clusters_kubernetes_namespaces'
  TRIGGER_FUNCTION_NAME = 'clusters_kubernetes_namespaces_sharding_key'
