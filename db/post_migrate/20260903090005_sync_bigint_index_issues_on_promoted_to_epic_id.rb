...
class SyncBigintIndexIssuesOnPromotedToEpicId < Gitlab::Database::Migration[2.3]
  ...
  INDEX_NAME = 'index_issues_on_promoted_to_epic_id'
  ...
  def up
    ...
    add_concurrent_index TABLE_NAME, [BIGINT_COLUMN], name: bigint_index_name(INDEX_NAME),
      where: 'promoted_to_epic_id_convert_to_bigint IS NOT NULL'
