...
class AddConcurrentIndexToShardingKeyColumnsOnClusterPlatformsKubernetes < Gitlab::Database::Migration[2.3]
  disable_ddl_transaction!
  milestone '18.9'

  TABLE_NAME = 'cluster_platforms_kubernetes'

  ORGANIZATION_INDEX = 'idx_cluster_platforms_kubernetes_on_organization_id'
  GROUP_INDEX = 'idx_cluster_platforms_kubernetes_on_group_id'
  PROJECT_INDEX = 'idx_cluster_platforms_kubernetes_on_project_id'
