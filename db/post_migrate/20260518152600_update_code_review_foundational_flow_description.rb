...
class UpdateCodeReviewFoundationalFlowDescription < Gitlab::Database::Migration[2.3]
  milestone '19.1'
  ...
  OLD_DESCRIPTION = 'Streamline code reviews by analyzing code changes, comments, and linked issues.'
