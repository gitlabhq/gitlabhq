...
class ReplaceForeignKeyOnProjectUploadStates < Gitlab::Database::Migration[2.3]
  disable_ddl_transaction!

  milestone '19.0'

  SOURCE_TABLE_NAME = :project_upload_states
  NEW_TARGET_TABLE = :project_uploads
  OLD_TARGET_TABLE = :uploads_archived
  COLUMN = :project_upload_id
  OLD_FOREIGN_KEY_NAME = :fk_a21cb2b8a2
  NEW_FOREIGN_KEY_NAME = :fk_rails_a21cb2b8a2
