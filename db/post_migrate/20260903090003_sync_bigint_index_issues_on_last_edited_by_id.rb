...
class SyncBigintIndexIssuesOnLastEditedById < Gitlab::Database::Migration[2.3]
  ...
  TABLE_NAME = 'issues'
  BIGINT_COLUMN = :last_edited_by_id_convert_to_bigint
  INDEX_NAME = 'index_issues_on_last_edited_by_id'
