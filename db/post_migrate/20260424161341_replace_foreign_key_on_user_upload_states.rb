...
class ReplaceForeignKeyOnUserUploadStates < Gitlab::Database::Migration[2.3]
  disable_ddl_transaction!

  milestone '19.0'

  SOURCE_TABLE_NAME = :user_upload_states
  NEW_TARGET_TABLE = :user_uploads
  OLD_TARGET_TABLE = :uploads_archived
  COLUMN = :user_upload_id
  OLD_FOREIGN_KEY_NAME = :fk_ee17d267b8
  NEW_FOREIGN_KEY_NAME = :fk_rails_ee17d267b8
