...
class FixInvalidRecordsCiBuildTraceMetadata < Gitlab::Database::Migration[2.2]
  milestone '16.8'
  restrict_gitlab_migration gitlab_schema: :gitlab_ci
  disable_ddl_transaction!

  CONSTRAINED_TABLE = 'ci_build_trace_metadata'
  ...
  def up
    ...
    each_batch(CONSTRAINED_TABLE) do |batch|
      batch
      .where('NOT EXISTS (SELECT 1 FROM "ci_job_artifacts" WHERE (id = trace_artifact_id))')
      .delete_all
    end
  end
