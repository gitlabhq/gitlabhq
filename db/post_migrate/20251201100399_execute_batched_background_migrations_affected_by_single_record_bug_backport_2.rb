...
class ExecuteBatchedBackgroundMigrationsAffectedBySingleRecordBugBackport2 < Gitlab::Database::Migration[2.3]
  ...
  #   - migration version changed to `20251201100399` (before the first post-deployment migration in 18.8)
  #   - milestone changed to 18.8
