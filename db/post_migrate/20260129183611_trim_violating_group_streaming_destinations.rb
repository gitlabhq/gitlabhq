...
class TrimViolatingGroupStreamingDestinations < Gitlab::Database::Migration[2.3]
  milestone '18.9'
  ...
  class GroupExternalStreamingDestination < MigrationRecord
    include EachBatch
  ...
  def up
    GroupExternalStreamingDestination
      ...
      .each_batch(of: BATCH_SIZE) do |batch|
        ...
        sql = <<~SQL
          ...
          WHERE audit_events_group_external_streaming_destinations.id = t.id
        SQL
