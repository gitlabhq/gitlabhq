...
class PrepareAsyncIndexPolicyRuleIdOnApprovalProjectRules < Gitlab::Database::Migration[2.2]
  milestone '17.1'
  ...
  def down
    unprepare_async_index :approval_project_rules, :approval_policy_rule_id, name: INDEX_NAME
  end
end
