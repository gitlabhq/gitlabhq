...
class ReplaceForeignKeyOnAbuseReportUploadStates < Gitlab::Database::Migration[2.3]
  disable_ddl_transaction!

  milestone '19.0'

  SOURCE_TABLE_NAME = :abuse_report_upload_states
  NEW_TARGET_TABLE = :abuse_report_uploads
  OLD_TARGET_TABLE = :uploads_archived
  COLUMN = :abuse_report_upload_id
  OLD_FOREIGN_KEY_NAME = :fk_6105b8ff69
  NEW_FOREIGN_KEY_NAME = :fk_rails_6105b8ff69
