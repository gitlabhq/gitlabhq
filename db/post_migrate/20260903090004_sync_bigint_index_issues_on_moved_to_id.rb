...
class SyncBigintIndexIssuesOnMovedToId < Gitlab::Database::Migration[2.3]
  ...
  INDEX_NAME = 'index_issues_on_moved_to_id'
  ...
  def up
    ...
    add_concurrent_index TABLE_NAME, [BIGINT_COLUMN], name: bigint_index_name(INDEX_NAME),
      where: 'moved_to_id_convert_to_bigint IS NOT NULL'
