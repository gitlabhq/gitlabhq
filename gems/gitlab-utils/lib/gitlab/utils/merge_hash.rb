...
module Gitlab
  module Utils
    module MergeHash
      ...
      def merge_hash_tree(first_element, second_element) # rubocop:disable Metrics/CyclomaticComplexity, Metrics/PerceivedComplexity -- recursive hash merge with mixed Array/Hash types
        ...
        # [Hash, Hash]
          ...
          first_element.deep_merge(second_element) { |_key, first, second| merge_hash_tree(first, second) }
