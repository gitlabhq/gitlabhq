...
RSpec.describe "ActiveContext::Preprocessors::Embeddings#apply_embeddings_by_root_namespace", :aggregate_failures do
  describe '.apply_embeddings_by_root_namespace' do
    it_behaves_like 'content_method and content_field variations',
      embeddings_method: :apply_embeddings_by_root_namespace,
      mock_reference_base_class: Test::References::MockWithWritableRootNamespace
  end

  describe 'generating embeddings per namespace' do
