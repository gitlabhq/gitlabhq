...
module OpenbaoClient
  class LdapConfigureRequest
    ...
    # The desired length of passwords that OpenBao generates.
    ...
    attr_accessor :skip_static_role_import_rotation
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenbaoClient::LdapConfigureRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenbaoClient::LdapConfigureRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'schema')
        ...
        self.schema = 'openldap'
      end

      if attributes.key?(:'skip_static_role_import_rotation')
        self.skip_static_role_import_rotation = attributes[:'skip_static_role_import_rotation']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          schema == o.schema &&
          skip_static_role_import_rotation == o.skip_static_role_import_rotation &&
          starttls == o.starttls &&
