...
module OpenbaoClient
  class DatabaseConfigureConnectionRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenbaoClient::DatabaseConfigureConnectionRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenbaoClient::DatabaseConfigureConnectionRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'root_rotation_statements')
        if (value = attributes[:'root_rotation_statements']).is_a?(Array)
          self.root_rotation_statements = value
        end
      end

      if attributes.key?(:'verify_connection')
        self.verify_connection = attributes[:'verify_connection']
      else
        self.verify_connection = true
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          root_rotation_statements == o.root_rotation_statements &&
          verify_connection == o.verify_connection
    end
    ...
    def hash
      [allowed_roles, password_policy, plugin_name, plugin_version, root_rotation_statements, verify_connection].hash
    end
