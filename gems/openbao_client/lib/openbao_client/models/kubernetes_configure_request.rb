...
module OpenbaoClient
  class KubernetesConfigureRequest
    ...
    attr_accessor :service_account_jwt
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenbaoClient::KubernetesConfigureRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenbaoClient::KubernetesConfigureRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'service_account_jwt')
        self.service_account_jwt = attributes[:'service_account_jwt']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_account_jwt == o.service_account_jwt
    end
    ...
    def hash
      [disable_local_ca_jwt, kubernetes_ca_cert, kubernetes_host, service_account_jwt].hash
    end
