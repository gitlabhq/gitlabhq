  ...
  class SshConfigureCaRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenbaoClient::SshConfigureCaRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenbaoClient::SshConfigureCaRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'generate_signing_key')
        self.generate_signing_key = attributes[:'generate_signing_key']
      else
        self.generate_signing_key = true
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          generate_signing_key == o.generate_signing_key &&
          key_bits == o.key_bits &&
          key_type == o.key_type &&
    ...
    def hash
      [generate_signing_key, key_bits, key_type, private_key, public_key].hash
    end
