...
module OpenbaoClient
  class KubernetesWriteAuthRoleRequest
    ...
    attr_accessor :alias_name_source
    ...
    attr_accessor :bound_service_account_namespace_selector

    # List of namespaces allowed to access this role. If set to \"*\" all namespaces are allowed.
    attr_accessor :bound_service_account_namespaces
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenbaoClient::KubernetesWriteAuthRoleRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenbaoClient::KubernetesWriteAuthRoleRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'alias_name_source')
        self.alias_name_source = attributes[:'alias_name_source']
      else
        self.alias_name_source = 'serviceaccount_uid'
      end
      ...
      if attributes.key?(:'bound_service_account_namespace_selector')
        self.bound_service_account_namespace_selector = attributes[:'bound_service_account_namespace_selector']
      end

      if attributes.key?(:'bound_service_account_namespaces')
        if (value = attributes[:'bound_service_account_namespaces']).is_a?(Array)
          self.bound_service_account_namespaces = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          alias_name_source == o.alias_name_source &&
          audience == o.audience &&
          bound_cidrs == o.bound_cidrs &&
          bound_service_account_names == o.bound_service_account_names &&
          bound_service_account_namespace_selector == o.bound_service_account_namespace_selector &&
          bound_service_account_namespaces == o.bound_service_account_namespaces &&
          max_ttl == o.max_ttl &&
          num_uses == o.num_uses &&
          period == o.period &&
          policies == o.policies &&
