...
module OpenbaoClient
  class AppRoleLookUpSecretIdResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenbaoClient::AppRoleLookUpSecretIdResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenbaoClient::AppRoleLookUpSecretIdResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'secret_id_accessor')
        self.secret_id_accessor = attributes[:'secret_id_accessor']
      end

      if attributes.key?(:'secret_id_num_uses')
        self.secret_id_num_uses = attributes[:'secret_id_num_uses']
      end

      if attributes.key?(:'secret_id_ttl')
        self.secret_id_ttl = attributes[:'secret_id_ttl']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          metadata == o.metadata &&
          secret_id_accessor == o.secret_id_accessor &&
    ...
    def hash
      [cidr_list, creation_time, expiration_time, last_updated_time, metadata, secret_id_accessor, secret_id_num_uses, secret_id_ttl, token_bound_cidrs].hash
    end
