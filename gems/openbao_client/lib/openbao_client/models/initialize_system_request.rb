...
module OpenbaoClient
  class InitializeSystemRequest
    ...
    attr_accessor :root_token_pgp_key
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenbaoClient::InitializeSystemRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenbaoClient::InitializeSystemRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'recovery_pgp_keys')
        if (value = attributes[:'recovery_pgp_keys']).is_a?(Array)
          self.recovery_pgp_keys = value
        end
      end

      if attributes.key?(:'recovery_shares')
        self.recovery_shares = attributes[:'recovery_shares']
      end
      ...
      if attributes.key?(:'root_token_pgp_key')
        self.root_token_pgp_key = attributes[:'root_token_pgp_key']
      end
      ...
      if attributes.key?(:'stored_shares')
        self.stored_shares = attributes[:'stored_shares']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          pgp_keys == o.pgp_keys &&
          recovery_pgp_keys == o.recovery_pgp_keys &&
          recovery_shares == o.recovery_shares &&
          recovery_threshold == o.recovery_threshold &&
          root_token_pgp_key == o.root_token_pgp_key &&
          secret_shares == o.secret_shares &&
          secret_threshold == o.secret_threshold &&
          stored_shares == o.stored_shares
    end
    ...
    def hash
      [pgp_keys, recovery_pgp_keys, recovery_shares, recovery_threshold, root_token_pgp_key, secret_shares, secret_threshold, stored_shares].hash
    end
