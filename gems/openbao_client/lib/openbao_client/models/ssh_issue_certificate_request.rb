...
module OpenbaoClient
  class SshIssueCertificateRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenbaoClient::SshIssueCertificateRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenbaoClient::SshIssueCertificateRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'cert_type')
        self.cert_type = attributes[:'cert_type']
      else
        self.cert_type = 'user'
      end

      if attributes.key?(:'critical_options')
        self.critical_options = attributes[:'critical_options']
      end
      ...
      if attributes.key?(:'valid_principals')
        self.valid_principals = attributes[:'valid_principals']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          critical_options == o.critical_options &&
          extensions == o.extensions &&
          key_bits == o.key_bits &&
          key_id == o.key_id &&
          key_type == o.key_type &&
          ttl == o.ttl &&
          valid_principals == o.valid_principals
    end
    ...
    def hash
      [cert_type, critical_options, extensions, key_bits, key_id, key_type, ttl, valid_principals].hash
    end
