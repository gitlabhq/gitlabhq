...
module OpenbaoClient
  class MfaConfigureDuoMethodRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenbaoClient::MfaConfigureDuoMethodRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenbaoClient::MfaConfigureDuoMethodRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'push_info')
        self.push_info = attributes[:'push_info']
      end
      ...
      if attributes.key?(:'use_passcode')
        self.use_passcode = attributes[:'use_passcode']
      end

      if attributes.key?(:'username_format')
        self.username_format = attributes[:'username_format']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          push_info == o.push_info &&
          secret_key == o.secret_key &&
          use_passcode == o.use_passcode &&
          username_format == o.username_format
    end
    ...
    def hash
      [api_hostname, integration_key, method_name, push_info, secret_key, use_passcode, username_format].hash
    end
