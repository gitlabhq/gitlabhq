...
module OpenbaoClient
  class MfaConfigureTotpMethodRequest
    ...
    attr_accessor :max_validation_attempts
    ...
    def self.openapi_types
      {
        ...
        :'issuer' => :'String',
        :'key_size' => :'Integer',
        :'max_validation_attempts' => :'Integer',
        :'method_name' => :'String',
        :'period' => :'Integer',
        :'qr_size' => :'Integer',
        :'skew' => :'Integer'
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenbaoClient::MfaConfigureTotpMethodRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenbaoClient::MfaConfigureTotpMethodRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'max_validation_attempts')
        self.max_validation_attempts = attributes[:'max_validation_attempts']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          issuer == o.issuer &&
          key_size == o.key_size &&
          max_validation_attempts == o.max_validation_attempts &&
    ...
    def hash
      [algorithm, digits, issuer, key_size, max_validation_attempts, method_name, period, qr_size, skew].hash
    end
