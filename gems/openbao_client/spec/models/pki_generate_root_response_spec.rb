...
# Unit tests for OpenbaoClient::PkiGenerateRootResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenbaoClient::PkiGenerateRootResponse do
  let(:instance) { OpenbaoClient::PkiGenerateRootResponse.new }

  describe 'test an instance of PkiGenerateRootResponse' do
    it 'should create an instance of PkiGenerateRootResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenbaoClient::PkiGenerateRootResponse)
    end
  end
