...
# Unit tests for OpenbaoClient::PkiRotateRootResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenbaoClient::PkiRotateRootResponse do
  let(:instance) { OpenbaoClient::PkiRotateRootResponse.new }

  describe 'test an instance of PkiRotateRootResponse' do
    it 'should create an instance of PkiRotateRootResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenbaoClient::PkiRotateRootResponse)
    end
  end
