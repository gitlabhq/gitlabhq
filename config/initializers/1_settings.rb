...
Settings.cron_jobs['ci_rescue_stale_live_trace_worker'] ||= Settingslogic.new({})
Settings.cron_jobs['ci_rescue_stale_live_trace_worker']['cron'] ||= '17 * * * *'
Settings.cron_jobs['ci_rescue_stale_live_trace_worker']['job_class'] = 'Ci::RescueStaleLiveTraceWorker'
