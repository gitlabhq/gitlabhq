...
Settings.cron_jobs['clear_shared_runners_minutes_worker']['cron'] ||= '0 0 0 * *'
Settings.cron_jobs['clear_shared_runners_minutes_worker']['job_class'] = 'ClearSharedRunnerMinutesWorker'
