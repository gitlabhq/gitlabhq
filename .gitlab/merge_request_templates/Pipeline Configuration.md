<!-- See Pipelines for the GitLab project: https://docs.gitlab.com/development/pipelines/ -->
...
- [ ] Different [pipeline types](https://docs.gitlab.com/development/pipelines/#pipelines-types-for-merge-requests)
