...
<i class="fa-youtube-play" aria-hidden="true"></i>Auto DevOpsの概要については、[Auto DevOps](https://youtu.be/0Tc0YYBxqi4)をご覧ください。
...
| ステージ  | Auto DevOpsの機能 |
|--------|---------------------|
| Build  | [自動ビルド](stages.md#auto-build) |
| Build  | [自動依存関係スキャン](stages.md#auto-dependency-scanning) |
| Test   | [自動テスト](stages.md#auto-test) |
| Test   | [自動ブラウザパフォーマンス試験](stages.md#auto-browser-performance-testing) |
| Test   | [自動コードインテリジェンス](stages.md#auto-code-intelligence) |
| Test   | [自動コード品質](stages.md#auto-code-quality) |
| Test   | [自動コンテナスキャン](stages.md#auto-container-scanning) |
| Deploy | [Autoレビューアプリ](stages.md#auto-review-apps) |
| Deploy | [自動デプロイ](stages.md#auto-deploy) |
| Secure | [自動動的アプリケーションセキュリティテスト（DAST）](stages.md#auto-dast) |
| Secure | [自動静的アプリケーションセキュリティテスト（SAST）](stages.md#auto-sast) |
| Secure | [自動シークレット検出](stages.md#auto-secret-detection) |
...
1. トップバーで、**検索または移動先**を選択し、グループを見つけてください。
1. **設定** > **CI/CD**を選択します。
1. **Auto DevOps**を展開します。
1. **デフォルトのAuto DevOpsパイプライン**チェックボックスをオンにします。
1. **変更を保存**を選択します。
