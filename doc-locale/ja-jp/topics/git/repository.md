...
- [リポジトリサイズ](../../user/project/repository/repository_size.md)
  ...
  - [GitLab UIを使用したリポジトリサイズの削減方法](../../user/project/repository/repository_size.md#methods-to-reduce-repository-size)
...
1. 強制プッシュで変更をプッシュします:
   ...
   > [!note]
   > このステップは、[保護ブランチ](../../user/project/repository/branches/protected.md)と[保護タグ](../../user/project/protected_tags.md)では失敗します。続行するには、一時的に保護を削除します。
