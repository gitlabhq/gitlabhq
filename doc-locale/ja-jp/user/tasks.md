...
- プロジェクトのゲスト、プランナー、レポーター、デベロッパー、メンテナー、またはオーナーのロールを持っているか、プロジェクトが公開されている必要があります。
...
- プロジェクトのゲスト、プランナー、レポーター、デベロッパー、メンテナー、またはオーナーのロールを持っている必要があります。
...
- プロジェクトのプランナー、レポーター、デベロッパー、メンテナー、またはオーナーのロールを持っている必要があります。
...
> [!warning]ターゲットタイプが元のタイプのすべてのフィールドをサポートしていない場合、タイプを変更するとデータ損失が発生する可能性があります。
...
あるいは、コメントで`issue`、`objective`、または`key result`に続けて、[`/type`クイックアクション](project/quick_actions.md#type)を使用することもできます。
...
- 次のいずれかの条件を満たす必要があります。
  - タスクの作成者であり、かつプロジェクトのゲスト、レポーター、デベロッパー、またはメンテナーのロールを持っている必要があります。
...
- プロジェクトのプランナー、レポーター、デベロッパー、メンテナー、またはオーナーのロールを持っているか、タスクの作成者であるか、タスクに割り当てられている必要があります。

タスクのステータスを変更するには、次の手順に従います。

1. 上部のバーで、**検索または移動先**を選択して、プロジェクトを見つけます。
1. **Plan** > **イシュー**を選択し、表示するタスクを選択します。
...
参加者とは、タスクを操作したユーザーのことです。参加者の表示については、[参加者](participants.md)を参照してください。
...
タスクを機密に設定した場合、プロジェクトのレポーター、デベロッパー、メンテナー、またはオーナーのロールを持つユーザーのみがそのタスクにアクセスできます。ゲストロールまたは[最小](permissions.md#users-with-minimal-access)ロールを持つユーザーは、変更前に積極的に参加していたとしても、タスクにアクセスできません。
...
- マージリクエストを含むプロジェクトのデベロッパー、メンテナー、またはオーナーのロールを持っている必要があります。
- タスクを含むプロジェクトのレポーター、デベロッパー、メンテナー、またはオーナーのロールを持っている必要があります。
