...
拡大するコードベースや組織で必要なものを見つけましょう。プロジェクト全体の特定のコード、イシュー、マージリクエスト、その他のコンテンツを検索することで、時間を節約できます。ニーズに応じて、**基本的な検索**、[**高度な検索**](advanced_search.md)、[**完全一致コードの検索**](exact_code_search.md)の3種類の検索から選択できます。
