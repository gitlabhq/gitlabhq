...
- [GitLab Duoが初めて導入](https://about.gitlab.com/blog/gitlab-ai-assisted-features/)されたのはGitLab 16.0です。
...
|---------|----------|---------|----------------|--------------------------|
| [コード提案](../project/repository/code_suggestions/_index.md) | {{< yes >}} | {{< yes >}} | {{< yes >}} | {{< yes >}} |
| [GitLab Duo Chat（非エージェント型）](../gitlab_duo_chat/_index.md) | {{< yes >}} | {{< yes >}} | {{< yes >}} | {{< yes >}} |
...
| [コードレビュー<br>](code_review_classic.md) <sup>1</sup> | {{< no >}} | {{< no >}} | {{< yes >}} | {{< yes >}} |
...
これらの機能には、PremiumまたはUltimateのサブスクリプションと、GitLab Duo Enterpriseアドオンが必要です。
...
| [パイプラインビルダーエージェント](../duo_agent_platform/agents/foundational_agents/pipeline_builder.md) | {{< no >}} | {{< no >}} | {{< yes >}} | {{< no >}} |

## GitLab Duo Self-Hostedで利用可能な機能 {#features-available-in-gitlab-duo-self-hosted}

お客様の組織で言語モデルをセルフホストできます。

GitLab Duo Self-Hostedで利用可能なGitLab Duo機能を確認するには、[サポートされている機能リスト](../../administration/gitlab_duo_self_hosted/_index.md#feature-versions-and-status)を参照してください。
