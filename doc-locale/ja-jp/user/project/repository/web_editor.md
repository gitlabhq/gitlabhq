...
> [!note] [保護ブランチ](branches/protected.md)内のファイルを管理するには、適切な[permissions](../../permissions.md)（権限）が必要です。
...
> [!note]編集中に別のユーザーが同じファイルを編集してコミットすると、変更をコミットできません。`Someone edited the file the same time you did. Please check out the file and
...
Webエディタは[Monaco Editor](https://github.com/microsoft/monaco-editor)をベースにしており、いくつかの[accessibility features](https://github.com/microsoft/monaco-editor/wiki/Monaco-Editor-Accessibility-Guide)（アクセシビリティ機能）があります:
...
- [ファイルツリーブラウザ](files/file_tree_browser.md)
