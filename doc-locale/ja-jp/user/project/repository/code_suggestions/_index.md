...
- GitLab Self-Managedの場合、次の2つのオプションがあります:
  ...
  - 組織で[GitLab Duo Self-Hostedを使用](../../../../administration/gitlab_duo_self_hosted/_index.md)することができます。この場合、AIゲートウェイと言語モデルを自分でホストします。GitLabが管理するモデル、その他のサポートされる言語モデル、または独自の互換性のあるモデルを使用できます。
