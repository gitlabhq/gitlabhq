...
1. VS Codeで、**Settings** > **Extensions** > **GitLab**に移動します。
1. **管理** ({{< icon name="settings" >}}) > **設定** > **GitLab Duo**を選択します。
1. **GitLab** > **Duo Code Suggestionsのチェックボックスがオンになっていることを確認します: Enabled**が選択されていることを確認します。
...
1. **GitLab Duo Code Suggestion**チェックボックスをオフにします。
