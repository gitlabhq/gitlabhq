...
- GitLab 18.0では、グループへの招待はオーナーに限定されています。
...
|----------------------------------------------------------------------|--------------------------|
| 招待されたグループの直接メンバー                           | {{< yes >}}              |
| 招待されたグループの継承されたメンバー                        | {{< yes >}}              |
| 招待されたグループの共有メンバー<sup>1</sup>              | {{< yes >}}              |
| サブグループの直接メンバー。ただし、招待されたグループのメンバーではない    | {{< no >}}               |
| サブグループの継承されたメンバー。ただし、招待されたグループのメンバーではない | {{< no >}}               |
...
招待するグループの[表示レベル](../../public_access.md)は、プロジェクトよりも制限が厳しいものであってはなりません。たとえば、次のように招待できます。
...
招待されたグループが**グループ**タブに表示されます。REST APIを使用して[プロジェクトの招待グループを一覧表示](../../../api/projects.md#list-all-invited-groups-in-a-project)することもできます。
...
|------------------------------------------------------------|------------------------|
| 招待されたグループの直接メンバー                 | {{< yes >}}            |
| 招待されたグループの継承されたメンバー              | {{< no >}}             |
| 招待されたグループの共有メンバー                 | {{< no >}}             |
| サブグループのメンバー。ただし、招待されたグループのメンバーではない | {{< no >}}             |
...
1. **管理** > **メンバー**を選択します。
1. **グループ**タブを選択します。
1. 削除するグループの右側にある**グループを削除**（{{< icon name="remove" >}}）を選択します。
...
この際、**動物**グループの階層外へのグループの招待を禁止した場合、次のようになります。
