...
実行中のパイプラインを表示するには、**ビルド** > **パイプライン**に移動します。パイプラインが成功すると、Pagesサイトはデプロイされ、アクセス可能になります。
...
1. デプロイされたGitLab Pagesサイトにアクセスするには、URLを選択してください。

> [!note]
> パイプラインが完了してからサイトが利用可能になるまで、数分かかる場合があります。
