...
- [コードレビューフロー](../../duo_agent_platform/flows/foundational_flows/code_review.md): GitLab Duo Agent Platformの機能。GitLabクレジットを使用します。
- [GitLab Duoコードレビュー](../../gitlab_duo/code_review_classic.md): GitLab Duoの機能。GitLab Duo Enterpriseアドオンを持つユーザーが利用できます。
