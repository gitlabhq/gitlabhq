...
CI/CDパイプラインの問題をトラブルシューティングするには、[CI/CDパイプラインのデバッグ](../../../ci/debugging.md)を参照してください。

半線形または早送りマージメソッドを使用するプロジェクトの場合、手動リベースステップをスキップするために[マージ前の自動リベース](methods/_index.md#automatic-rebase-before-merge)を有効にすることもできます。
