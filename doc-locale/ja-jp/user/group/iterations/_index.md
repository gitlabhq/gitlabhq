...
> [!note]
> 
> プロジェクトでイシュートラッキングが[オフになっている](../../project/settings/_index.md#configure-project-features-and-permissions)場合、イテレーションリストを表示するには、そのURLを入力します。そのためには、プロジェクトまたはグループのURLに`/-/cadences`を追加します。たとえば、`https://gitlab.com/gitlab-org/sample-data-templates/sample-gitlab-project/-/cadences`のようになります。[イシュー339009](https://gitlab.com/gitlab-org/gitlab/-/issues/339009)により、この改善を追跡しています。
