...
- パブリックプロジェクトと内部プロジェクトは、**GitLab Pages**と**セキュリティとコンプライアンス**を除くすべての[プロジェクト機能](../project/settings/_index.md#configure-project-features-and-permissions)が**アクセスできる人すべて**に設定されている場合、認証済みユーザー全員が新しいプロジェクトのテンプレートとして選択できます。
