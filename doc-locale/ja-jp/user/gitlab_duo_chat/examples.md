...
以下のChat機能には、エージェント型バージョンがあり、[GitLabクレジット](../../subscriptions/gitlab_credits.md)を消費します。非エージェント型バージョンはGitLabクレジットを消費しません:
...
両方のAgentic Chatと非エージェント型Chatにアクセスできる場合、デフォルトの機能バージョンは、使用しているツールによって異なります:

- GitLab UIでは、デフォルトのChatバージョンは、GitLab Duoサイドバーで最後に選択したバージョンです。
- サポートされているIDEでは、デフォルトのChatバージョンは、設定によって決定されます。
...
- GitLab Duo非エージェント型Chat: GitLab UI、Web IDE、VS Code、JetBrains IDE、Visual Studio、Eclipse
...
- エディタ - GitLab Duo非エージェント型Chat: GitLab UI、Web IDE、VS Code、JetBrains IDE、Visual Studio、Eclipse
...
- GitLab Duo非エージェント型Chat: VS Code、JetBrains IDE、Visual Studio、およびEclipse
...
サポートされているIDEのGitLab Duo Chatの会話にリポジトリファイルを追加するには、`/include`と入力してファイルを選択します。
...
- エディタ - GitLab Duo非エージェント型Chat: Web IDE、VS Code、JetBrains IDE、Visual Studio、およびEclipse
- Amazon QのLLM: Amazon Q Developer
- [セルフホストモデル対応のGitLab Duo](../../administration/gitlab_duo_self_hosted/_index.md)で利用可能
...
- GitLab Duo非エージェント型Chat: Web IDE、VS Code、JetBrains IDE、Visual Studio、およびEclipse
