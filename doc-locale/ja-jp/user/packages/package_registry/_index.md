...
CI/CDを使用してパッケージをビルドする場合、パッケージの詳細を表示すると、拡張されたアクティビティ情報が表示されます。

![パッケージCI/CDアクティビティ](img/package_activity_v12_10.png)
...
| 内部           | パッケージをプルする        | ゲスト（1）                                               |
| 非公開            | パッケージレジストリを表示する | レポーター                                                |
| 非公開            | パッケージを公開する     | デベロッパー                                               |
| 非公開            | パッケージをプルする        | レポーター（1）                                            |
...
1. トップバーで、**検索または移動先**を選択し、プライベートまたは内部プロジェクトを見つけます。
1. **設定** > **一般**を選択します。
