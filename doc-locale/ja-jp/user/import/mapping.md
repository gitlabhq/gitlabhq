...
> [!note]
> プレースホルダユーザーを削除する他の方法は存在しませんが、[イシュー519391](https://gitlab.com/gitlab-org/gitlab/-/issues/519391)および[イシュー537340](https://gitlab.com/gitlab-org/gitlab/-/issues/537340)で改善のサポートが提案されています。
