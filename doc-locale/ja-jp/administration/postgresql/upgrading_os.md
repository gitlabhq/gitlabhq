...
1. すべてのPostgreSQLノードで、オペレーティングシステムのアップグレード後に、[GitLabのパッケージソースを更新](../../update/package/_index.md)します。
...
1. すべてのサイトのすべてのPostgreSQLノードで、オペレーティングシステムのアップグレード後に、[GitLabのパッケージソースを更新](../../update/package/_index.md)します。
