...
> [!note]
> GitLab Freeは少数の異なる監査イベントを追跡します。GitLab Premiumでは、さらに多くの監査イベントを追跡します。
...
> [!note]
> rawログを機能使用状況の分析に使用することはお勧めしません。データ品質の正確性はまだ認定されていません。
>
...
> [!note]
> GitLabサポートはこれらのいずれかを要求することが多く、必要なツールを保守しています。
