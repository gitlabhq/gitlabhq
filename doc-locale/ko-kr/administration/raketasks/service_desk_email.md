...
title: Service Desk 이메일 Rake 작업
---
...
GitLab은 [Service Desk 이메일](../../user/project/service_desk/configure.md#configure-service-desk-alias-email) 비밀번호를 파일 시스템에 일반 텍스트로 저장하는 대신 암호화된 파일에서 읽을 수 있습니다. 다음은 암호화된 파일의 내용을 업데이트하기 위해 제공되는 Rake 작업입니다.

### 비밀번호 표시 {#show-secret}

현재 Service Desk 이메일 비밀번호의 내용을 표시합니다.
...
Kubernetes 비밀을 사용하여 Service Desk 이메일 비밀번호를 저장합니다. 자세한 내용은 [Helm IMAP 비밀](https://docs.gitlab.com/charts/installation/secrets/#imap-password-for-service-desk-emails)을 참조하세요.
