...
title: Personnaliser les instructions de revue pour GitLab Duo
---
...
- [Introduit](https://gitlab.com/gitlab-org/gitlab/-/issues/545136) dans GitLab 18.2 en tant que [bêta](../../../policy/development_stages_support.md#beta) [avec un flag](../../../administration/feature_flags/_index.md) nommé `duo_code_review_custom_instructions`. Désactivé par défaut.
...
- Le feature flag `duo_code_review_custom_instructions` [supprimé](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/202262) dans GitLab 18.4.
...
1. Facultatif : Ajoutez une entrée [Code Owners](../../project/codeowners/_index.md) pour protéger les modifications apportées au fichier `mr-review-instructions.yaml`.
...
- [Introduit](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/230090) dans GitLab 19.0.
...
1. Sous **Instructions de revue personnalisées pour les groupes**, sélectionnez un projet dans votre groupe.
...
- Concentrez-vous sur les normes les plus importantes.
