  ...
  module Danger
    module ProjectHelper
      ...
      CATEGORIES = {
        ...
        # Auto-generated JavaScript path helpers do not need frontend review, they are generated by `/lib/gitlab/js_routes.rb`
        # They cannot be manually modified because `bin/rake gitlab:js:routes:updated_check` check is run in CI.
        %r{\A(ee/)?app/assets/javascripts/lib/utils/path_helpers/.*\.js\z} => :none,
        # Generates the path helpers above, so it warrants frontend review.
        %r{\Alib/gitlab/js_routes\.rb\z} => [:frontend, :backend],
        ...
        %r{\A((ee|jh)/)?spec/(javascripts|frontend)/} => :frontend,
